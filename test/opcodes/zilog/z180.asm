...
;   Z180.ASM
;
;   Opcode test for the SB-Assembler Z180 cross
;
;---------------------------------------------------------------------------

                .CR     Z180            It's a Z180 assembler now
                .TF     test.hex,hex
                .LI     TON
...
;---------------------------------------------------------------------------
                ...
                RLD
                RRD
                SLP                     Unique to Z180 (not all models!)
...
;---------------------------------------------------------------------------
                ...
                TST     A,L             New to Z180
                TST     (HL)            New to Z180
                TST     A,(HL)          New to Z180
                TST     $68             New to Z180
                TST     A,$68           New to Z180
...
;---------------------------------------------------------------------------
                ...
                IM0             Alternative notation of IM 0
                IM1             Alternative notation of IM 1
                IM2             Alternative notation of IM 2
