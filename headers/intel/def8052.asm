...
;   def8052.asm
;
;   Definition file for 8052 Microcontroller
;
;---------------------------------------------------------------------------
...
MAX_RAM     =       0FFH        Last internal RAM address
STACK_INIT  =       0EFH        Allows 16 bytes of stack space (0F0H..0FFH)         
...
T2CON       .EQ     0C8H        Timer/counter 2 Control
RCAP2L      .EQ     0CAH        T/C 2 Capture register Low byte
RCAP2H      .EQ     0CBH        T/C 2 Capture register High byte
TL2         .EQ     0CCH        Timer/Counter 2 Low byte
TH2         .EQ     0CDH        Timer/Counter 2 High byte
...
TF2         .EQ     T2CON.7     Timer 2 overflow flag
EXF2        .EQ     T2CON.6     Timer 2 external flag
RCLK        .EQ     T2CON.5     Receive clock flag
TCLK        .EQ     T2CON.4     Transmit clock flag
EXEN2       .EQ     T2CON.3     Timer 2 external enable flag
TR2         .EQ     T2CON.2     Software start/stop control
C_T2        .EQ     T2CON.1     Timer or counter select
CP_RL2      .EQ     T2CON.0     Capture/reload flag
