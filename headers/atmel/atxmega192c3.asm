...
;*
;* Number            : AVR000
;* File Name         : ATxmega192C3def.inc
;* Title             : Register/Bit Definitions for the ATxmega192C3
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega192C3
;*
;* DESCRIPTION
...
PROGMEM_END     =   0x00000+0x32000-1

APP_SECTION_START   =   0x00000
APP_SECTION_SIZE    =   0x30000
APP_SECTION_END     =   0x00000+0x30000-1
