...
;*
;* Number            : AVR000
;* File Name         : ATxmega128B1def.inc
;* Title             : Register/Bit Definitions for the ATxmega128B1
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega128B1
;*
;* DESCRIPTION
...
PORTE_INT0_vect = 108 ; External Interrupt 0
PORTE_INT1_vect = 110 ; External Interrupt 1

; TCE0 interrupt vectors
TCE0_OVF_vect = 116 ; Overflow Interrupt
TCE0_ERR_vect = 118 ; Error Interrupt
TCE0_CCA_vect = 120 ; Compare or Capture A Interrupt
TCE0_CCB_vect = 122 ; Compare or Capture B Interrupt
TCE0_CCC_vect = 124 ; Compare or Capture C Interrupt
TCE0_CCD_vect = 126 ; Compare or Capture D Interrupt

; TCE2 interrupt vectors
TCE2_LUNF_vect = 116 ; Low Byte Underflow Interrupt
TCE2_HUNF_vect = 118 ; High Byte Underflow Interrupt
TCE2_LCMPA_vect = 120 ; Low Byte Compare A Interrupt
TCE2_LCMPB_vect = 122 ; Low Byte Compare B Interrupt
TCE2_LCMPC_vect = 124 ; Low Byte Compare C Interrupt
TCE2_LCMPD_vect = 126 ; Low Byte Compare D Interrupt

; USARTE0 interrupt vectors
USARTE0_RXC_vect = 138 ; Reception Complete Interrupt
USARTE0_DRE_vect = 140 ; Data Register Empty Interrupt
USARTE0_TXC_vect = 142 ; Transmission Complete Interrupt

; PORTA interrupt vectors
PORTA_INT0_vect = 150 ; External Interrupt 0
PORTA_INT1_vect = 152 ; External Interrupt 1

; ACA interrupt vectors
ACA_AC0_vect = 154 ; AC0 Interrupt
ACA_AC1_vect = 156 ; AC1 Interrupt
ACA_ACW_vect = 158 ; ACW Window Mode Interrupt

; ADCA interrupt vectors
ADCA_CH0_vect = 160 ; Interrupt 0
...
INT_VECTORS_SIZE = 162 ; size in words
