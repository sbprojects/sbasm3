...
;*
;* Number            : AVR000
;* File Name         : ATxmega32C3def.inc
;* Title             : Register/Bit Definitions for the ATxmega32C3
;* Created           : 2016-09-15 15:01
;* Version           : 1.00
;* Support e-mail    : avr@atmel.com
;* Target MCU        : ATxmega32C3
;*
;* DESCRIPTION
...
ADCA_SAMPCTRL = 520                 ; Sampling Time Control Register
ADCA_CAL = 524                      ; Calibration Value
ADCA_CH0RES = 528                   ; Channel 0 Result
ADCA_CMP = 536                      ; Compare Value
ADCA_CH0_CTRL = 544                 ; CH0 Control Register
ADCA_CH0_MUXCTRL = 545              ; CH0 MUX Control
ADCA_CH0_INTCTRL = 546              ; CH0 Channel Interrupt Control Register
ADCA_CH0_INTFLAGS = 547             ; CH0 Interrupt Flags
ADCA_CH0_RES = 548                  ; CH0 Channel Result
ADCA_CH0_SCAN = 550                 ; CH0 Input Channel Scan
...
TWIC_MASTER_CTRLA = 1153            ; MASTER Control Register A
TWIC_MASTER_CTRLB = 1154            ; MASTER Control Register B
TWIC_MASTER_CTRLC = 1155            ; MASTER Control Register C
TWIC_MASTER_STATUS = 1156           ; MASTER Status Register
TWIC_MASTER_BAUD = 1157             ; MASTER Baurd Rate Control Register
TWIC_MASTER_ADDR = 1158             ; MASTER Address Register
TWIC_MASTER_DATA = 1159             ; MASTER Data Register
TWIC_SLAVE_CTRLA = 1160             ; SLAVE Control Register A
TWIC_SLAVE_CTRLB = 1161             ; SLAVE Control Register B
TWIC_SLAVE_STATUS = 1162            ; SLAVE Status Register
TWIC_SLAVE_ADDR = 1163              ; SLAVE Address Register
TWIC_SLAVE_DATA = 1164              ; SLAVE Data Register
TWIC_SLAVE_ADDRMASK = 1165          ; SLAVE Address Mask Register
...
TWIE_MASTER_CTRLA = 1185            ; MASTER Control Register A
TWIE_MASTER_CTRLB = 1186            ; MASTER Control Register B
TWIE_MASTER_CTRLC = 1187            ; MASTER Control Register C
TWIE_MASTER_STATUS = 1188           ; MASTER Status Register
TWIE_MASTER_BAUD = 1189             ; MASTER Baurd Rate Control Register
TWIE_MASTER_ADDR = 1190             ; MASTER Address Register
TWIE_MASTER_DATA = 1191             ; MASTER Data Register
TWIE_SLAVE_CTRLA = 1192             ; SLAVE Control Register A
TWIE_SLAVE_CTRLB = 1193             ; SLAVE Control Register B
TWIE_SLAVE_STATUS = 1194            ; SLAVE Status Register
TWIE_SLAVE_ADDR = 1195              ; SLAVE Address Register
TWIE_SLAVE_DATA = 1196              ; SLAVE Data Register
TWIE_SLAVE_ADDRMASK = 1197          ; SLAVE Address Mask Register
...
;*************************************************************************
;** TCC0 - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** TCC1 - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** TCD0 - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** TCE0 - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** TCF0 - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** TCC2 - 16-bit Timer/Counter type 2
;*************************************************************************
...
;*************************************************************************
;** TCD2 - 16-bit Timer/Counter type 2
;*************************************************************************
...
;*************************************************************************
;** TCE2 - 16-bit Timer/Counter type 2
;*************************************************************************
...
;*************************************************************************
;** TCF2 - 16-bit Timer/Counter type 2
;*************************************************************************
...
;*************************************************************************
;** AWEXC - Timer/Counter Advanced Waveform Extension
;*************************************************************************
...
;*************************************************************************
;** HIRESC - Timer/Counter High-Resolution Extension
;*************************************************************************
...
;*************************************************************************
;** USARTE0 - Universal Asynchronous Receiver-Transmitter
;*************************************************************************
...
;*************************************************************************
;** SPID - Serial Peripheral Interface
;*************************************************************************
...
TWIE_base = 0x04A0                  ; Two-Wire Interface
USB_base = 0x04C0                   ; USB
PORTA_base = 0x0600                 ; I/O Port Configuration
PORTB_base = 0x0620                 ; I/O Port Configuration
PORTC_base = 0x0640                 ; I/O Port Configuration
PORTD_base = 0x0660                 ; I/O Port Configuration
PORTE_base = 0x0680                 ; I/O Port Configuration
PORTF_base = 0x06A0                 ; I/O Port Configuration
PORTR_base = 0x07E0                 ; I/O Port Configuration
TCC0_base = 0x0800                  ; 16-bit Timer/Counter With PWM
TCC1_base = 0x0840                  ; 16-bit Timer/Counter With PWM
TCD0_base = 0x0900                  ; 16-bit Timer/Counter With PWM
TCE0_base = 0x0A00                  ; 16-bit Timer/Counter With PWM
TCF0_base = 0x0B00                  ; 16-bit Timer/Counter With PWM
TCC2_base = 0x0800                  ; 16-bit Timer/Counter type 2
TCD2_base = 0x0900                  ; 16-bit Timer/Counter type 2
TCE2_base = 0x0A00                  ; 16-bit Timer/Counter type 2
TCF2_base = 0x0B00                  ; 16-bit Timer/Counter type 2
AWEXC_base = 0x0880                 ; Timer/Counter Advanced Waveform Extension
HIRESC_base = 0x0890                ; Timer/Counter High-Resolution Extension
USARTC0_base = 0x08A0               ; Universal Asynchronous Receiver-Transmitter
USARTD0_base = 0x09A0               ; Universal Asynchronous Receiver-Transmitter
USARTE0_base = 0x0AA0               ; Universal Asynchronous Receiver-Transmitter
SPIC_base = 0x08C0                  ; Serial Peripheral Interface
SPID_base = 0x09C0                  ; Serial Peripheral Interface
...
ADC_SAMPCTRL_offset = 0x08          ; Sampling Time Control Register
...
; OCD_OCDR0 masks
OCD_OCDRD_gm = 0xFF                 ; OCDR Dirty group mask
OCD_OCDRD_gp = 0                    ; OCDR Dirty group position
OCD_OCDRD0_bm = 1<<0              ; OCDR Dirty bit 0 mask
OCD_OCDRD0_bp = 0                   ; OCDR Dirty bit 0 position
OCD_OCDRD1_bm = 1<<1              ; OCDR Dirty bit 1 mask
OCD_OCDRD1_bp = 1                   ; OCDR Dirty bit 1 position
OCD_OCDRD2_bm = 1<<2              ; OCDR Dirty bit 2 mask
OCD_OCDRD2_bp = 2                   ; OCDR Dirty bit 2 position
OCD_OCDRD3_bm = 1<<3              ; OCDR Dirty bit 3 mask
OCD_OCDRD3_bp = 3                   ; OCDR Dirty bit 3 position
OCD_OCDRD4_bm = 1<<4              ; OCDR Dirty bit 4 mask
OCD_OCDRD4_bp = 4                   ; OCDR Dirty bit 4 position
OCD_OCDRD5_bm = 1<<5              ; OCDR Dirty bit 5 mask
OCD_OCDRD5_bp = 5                   ; OCDR Dirty bit 5 position
OCD_OCDRD6_bm = 1<<6              ; OCDR Dirty bit 6 mask
OCD_OCDRD6_bp = 6                   ; OCDR Dirty bit 6 position
OCD_OCDRD7_bm = 1<<7              ; OCDR Dirty bit 7 mask
OCD_OCDRD7_bp = 7                   ; OCDR Dirty bit 7 position

; OCD_OCDR1 masks
; Masks for OCD_OCDRD already defined
...
; Masks for PR_SPI already defined
; Masks for PR_TC0 already defined

; PR_PRPE masks
; Masks for PR_TWI already defined
; Masks for PR_USART0 already defined
; Masks for PR_TC0 already defined
...
; PMIC_INTPRI masks
PMIC_INTPRI_gm = 0xFF               ; Interrupt Priority group mask
PMIC_INTPRI_gp = 0                  ; Interrupt Priority group position
PMIC_INTPRI0_bm = 1<<0            ; Interrupt Priority bit 0 mask
PMIC_INTPRI0_bp = 0                 ; Interrupt Priority bit 0 position
PMIC_INTPRI1_bm = 1<<1            ; Interrupt Priority bit 1 mask
PMIC_INTPRI1_bp = 1                 ; Interrupt Priority bit 1 position
PMIC_INTPRI2_bm = 1<<2            ; Interrupt Priority bit 2 mask
PMIC_INTPRI2_bp = 2                 ; Interrupt Priority bit 2 position
PMIC_INTPRI3_bm = 1<<3            ; Interrupt Priority bit 3 mask
PMIC_INTPRI3_bp = 3                 ; Interrupt Priority bit 3 position
PMIC_INTPRI4_bm = 1<<4            ; Interrupt Priority bit 4 mask
PMIC_INTPRI4_bp = 4                 ; Interrupt Priority bit 4 position
PMIC_INTPRI5_bm = 1<<5            ; Interrupt Priority bit 5 mask
PMIC_INTPRI5_bp = 5                 ; Interrupt Priority bit 5 position
PMIC_INTPRI6_bm = 1<<6            ; Interrupt Priority bit 6 mask
PMIC_INTPRI6_bp = 6                 ; Interrupt Priority bit 6 position
PMIC_INTPRI7_bm = 1<<7            ; Interrupt Priority bit 7 mask
PMIC_INTPRI7_bp = 7                 ; Interrupt Priority bit 7 position
...
ADC_CH_MUXNEG_gm = 0x07             ; MUX selection on Negative ADC input group mask
...
ADC_CH_MUXNEG2_bm = 1<<2          ; MUX selection on Negative ADC input bit 2 mask
ADC_CH_MUXNEG2_bp = 2               ; MUX selection on Negative ADC input bit 2 position
...
; ADC_SAMPCTRL masks
ADC_SAMPVAL_gm = 0x3F               ; Sampling Time Control group mask
ADC_SAMPVAL_gp = 0                  ; Sampling Time Control group position
ADC_SAMPVAL0_bm = 1<<0            ; Sampling Time Control bit 0 mask
ADC_SAMPVAL0_bp = 0                 ; Sampling Time Control bit 0 position
ADC_SAMPVAL1_bm = 1<<1            ; Sampling Time Control bit 1 mask
ADC_SAMPVAL1_bp = 1                 ; Sampling Time Control bit 1 position
ADC_SAMPVAL2_bm = 1<<2            ; Sampling Time Control bit 2 mask
ADC_SAMPVAL2_bp = 2                 ; Sampling Time Control bit 2 position
ADC_SAMPVAL3_bm = 1<<3            ; Sampling Time Control bit 3 mask
ADC_SAMPVAL3_bp = 3                 ; Sampling Time Control bit 3 position
ADC_SAMPVAL4_bm = 1<<4            ; Sampling Time Control bit 4 mask
ADC_SAMPVAL4_bp = 4                 ; Sampling Time Control bit 4 position
ADC_SAMPVAL5_bm = 1<<5            ; Sampling Time Control bit 5 mask
ADC_SAMPVAL5_bp = 5                 ; Sampling Time Control bit 5 position
...
; Masks for USB_SOFIF already defined
; Masks for USB_SUSPENDIF already defined
; Masks for USB_RESUMEIF already defined
; Masks for USB_RSTIF already defined
; Masks for USB_CRCIF already defined
; Masks for USB_UNFIF already defined
; Masks for USB_OVFIF already defined
; Masks for USB_STALLIF already defined
...
; Masks for USB_TRNIF already defined
; Masks for USB_SETUPIF already defined
...
; PORT_PIN1CTRL masks
; Masks for PORT_SRLEN already defined
...
; TC0_CTRLFSET masks
; Masks for TC0_CMD already defined
; Masks for TC0_LUPD already defined
; Masks for TC0_DIR already defined
...
; TC0_CTRLGSET masks
; Masks for TC0_CCDBV already defined
; Masks for TC0_CCCBV already defined
; Masks for TC0_CCBBV already defined
; Masks for TC0_CCABV already defined
; Masks for TC0_PERBV already defined
...
; TC1_CTRLFSET masks
; Masks for TC1_CMD already defined
; Masks for TC1_LUPD already defined
; Masks for TC1_DIR already defined
...
; TC1_CTRLGSET masks
; Masks for TC1_CCBBV already defined
; Masks for TC1_CCABV already defined
; Masks for TC1_PERBV already defined
...
; Masks for AWEX_FDF already defined
; Masks for AWEX_DTHSBUFV already defined
; Masks for AWEX_DTLSBUFV already defined
...
; HIRES_CTRLA masks
HIRES_HRPLUS_bm = 0x04              ; High Resolution Plus bit mask
...
NVM_FUSES_BODLVL_gm = 0x07          ; Brownout Detection Voltage Level group mask
NVM_FUSES_BODLVL_gp = 0             ; Brownout Detection Voltage Level group position
NVM_FUSES_BODLVL0_bm = 1<<0       ; Brownout Detection Voltage Level bit 0 mask
NVM_FUSES_BODLVL0_bp = 0            ; Brownout Detection Voltage Level bit 0 position
NVM_FUSES_BODLVL1_bm = 1<<1       ; Brownout Detection Voltage Level bit 1 mask
NVM_FUSES_BODLVL1_bp = 1            ; Brownout Detection Voltage Level bit 1 position
NVM_FUSES_BODLVL2_bm = 1<<2       ; Brownout Detection Voltage Level bit 2 mask
NVM_FUSES_BODLVL2_bp = 2            ; Brownout Detection Voltage Level bit 2 position
...
PROGMEM_SIZE    =   0x9000
PROGMEM_END     =   0x0000+0x9000-1

APP_SECTION_START   =   0x0000
APP_SECTION_SIZE    =   0x8000
APP_SECTION_END     =   0x0000+0x8000-1

APPTABLE_SECTION_START  =   0x7000
APPTABLE_SECTION_SIZE   =   0x1000
APPTABLE_SECTION_END    =   0x7000+0x1000-1

BOOT_SECTION_START  =   0x8000
BOOT_SECTION_SIZE   =   0x1000
BOOT_SECTION_END    =   0x8000+0x1000-1

DATAMEM_START   =   0x0000
DATAMEM_SIZE    =   0x3000
DATAMEM_END     =   0x0000+0x3000-1
...
INTERNAL_SRAM_SIZE      =   0x1000
INTERNAL_SRAM_END       =   0x2000+0x1000-1
...
PORTC_INT0_voffset = 0
PORTC_INT1_voffset = 2

; PORTR interrupt vector offsets

PORTR_INT0_voffset = 0
PORTR_INT1_voffset = 2
...
; TCC2 interrupt vector offsets

TCC2_LUNF_voffset = 0
TCC2_HUNF_voffset = 2
TCC2_LCMPA_voffset = 4
TCC2_LCMPB_voffset = 6
TCC2_LCMPC_voffset = 8
TCC2_LCMPD_voffset = 10

; TCC1 interrupt vector offsets
...
PORTB_INT0_voffset = 0
PORTB_INT1_voffset = 2

; PORTE interrupt vector offsets

PORTE_INT0_voffset = 0
PORTE_INT1_voffset = 2

; TWIE interrupt vector offsets
...
; TCE2 interrupt vector offsets

TCE2_LUNF_voffset = 0
TCE2_HUNF_voffset = 2
TCE2_LCMPA_voffset = 4
TCE2_LCMPB_voffset = 6
TCE2_LCMPC_voffset = 8
TCE2_LCMPD_voffset = 10

; USARTE0 interrupt vector offsets

USARTE0_RXC_voffset = 0
USARTE0_DRE_voffset = 2
USARTE0_TXC_voffset = 4

; PORTD interrupt vector offsets

PORTD_INT0_voffset = 0
PORTD_INT1_voffset = 2

; PORTA interrupt vector offsets

PORTA_INT0_voffset = 0
PORTA_INT1_voffset = 2
...
; TCD2 interrupt vector offsets

TCD2_LUNF_voffset = 0
TCD2_HUNF_voffset = 2
TCD2_LCMPA_voffset = 4
TCD2_LCMPB_voffset = 6
TCD2_LCMPC_voffset = 8
TCD2_LCMPD_voffset = 10

; SPID interrupt vector offsets
...
PORTF_INT0_voffset = 0
PORTF_INT1_voffset = 2
...
; TCF2 interrupt vector offsets

TCF2_LUNF_voffset = 0
TCF2_HUNF_voffset = 2
TCF2_LCMPA_voffset = 4
TCF2_LCMPB_voffset = 6
TCF2_LCMPC_voffset = 8
TCF2_LCMPD_voffset = 10
