...
BOOTSECTION1START	= 0xFE00 ; Note: Word address
BOOTSECTION1END	= 0xFFFF ; Note: Word address
BOOTSECTION1PAGESIZE	= 0x0100 ;

BOOTSECTION2START	= 0xFC00 ; Note: Word address
BOOTSECTION2END	= 0xFFFF ; Note: Word address
BOOTSECTION2PAGESIZE	= 0x0100 ;

BOOTSECTION3START	= 0xF800 ; Note: Word address
BOOTSECTION3END	= 0xFFFF ; Note: Word address
BOOTSECTION3PAGESIZE	= 0x0100 ;

BOOTSECTION4START	= 0xF000 ; Note: Word address
BOOTSECTION4END	= 0xFFFF ; Note: Word address
