...
;*
;* Number            : AVR000
;* File Name         : ATxmega32D3def.inc
;* Title             : Register/Bit Definitions for the ATxmega32D3
;* Created           : 2016-09-15 14:53
;* Version           : 1.00
;* Support e-mail    : avr@atmel.com
;* Target MCU        : ATxmega32D3
;*
;* DESCRIPTION
...
PORTA_REMAP = 1550                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTB_REMAP = 1582                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTC_REMAP = 1614                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTD_REMAP = 1646                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTE_REMAP = 1678                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTF_REMAP = 1710                  ; Pin Remap Register (available for PORTC to PORTF only)
...
PORTR_REMAP = 2030                  ; Pin Remap Register (available for PORTC to PORTF only)
...
;*************************************************************************
;** AWEXC - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** HIRESC - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** AWEXE - 16-bit Timer/Counter With PWM
;*************************************************************************
...
;*************************************************************************
;** SPIE - Serial Peripheral Interface
;*************************************************************************
...
VPORT0_base = 0x0010                ; Port Configuration
VPORT1_base = 0x0014                ; Port Configuration
VPORT2_base = 0x0018                ; Port Configuration
VPORT3_base = 0x001C                ; Port Configuration
PORTA_base = 0x0600                 ; Port Configuration
PORTB_base = 0x0620                 ; Port Configuration
PORTC_base = 0x0640                 ; Port Configuration
PORTD_base = 0x0660                 ; Port Configuration
PORTE_base = 0x0680                 ; Port Configuration
PORTF_base = 0x06A0                 ; Port Configuration
...
AWEXC_base = 0x0880                 ; 16-bit Timer/Counter With PWM
HIRESC_base = 0x0890                ; 16-bit Timer/Counter With PWM
TCD0_base = 0x0900                  ; 16-bit Timer/Counter With PWM
TCE0_base = 0x0A00                  ; 16-bit Timer/Counter With PWM
AWEXE_base = 0x0A80                 ; 16-bit Timer/Counter With PWM
...
SPIE_base = 0x0AC0                  ; Serial Peripheral Interface
...
PORT_REMAP_offset = 0x0E            ; Pin Remap Register (available for PORTC to PORTF only)
...
PR_HIRES_bm = 0x04                  ; Port C HIRES bit mask
PR_HIRES_bp = 2                     ; Port C HIRES bit position
...
NVM_FUSES_TOSCSEL_bm = 0x20         ; 32.768kHz Timer Oscillator Pin Selection bit mask
NVM_FUSES_TOSCSEL_bp = 5            ; 32.768kHz Timer Oscillator Pin Selection bit position
...
; Masks for AC_HSMODE already defined
...
TWI_MASTER_TIMEOUT_gm = 0x0C        ; Inactive Bus Tisdahmeout group mask
TWI_MASTER_TIMEOUT_gp = 2           ; Inactive Bus Tisdahmeout group position
TWI_MASTER_TIMEOUT0_bm = 1<<2     ; Inactive Bus Tisdahmeout bit 0 mask
TWI_MASTER_TIMEOUT0_bp = 2          ; Inactive Bus Tisdahmeout bit 0 position
TWI_MASTER_TIMEOUT1_bm = 1<<3     ; Inactive Bus Tisdahmeout bit 1 mask
TWI_MASTER_TIMEOUT1_bp = 3          ; Inactive Bus Tisdahmeout bit 1 position
...
; PORT_REMAP masks
PORT_SPI_bm = 0x20                  ; SPI Remap bit mask
PORT_SPI_bp = 5                     ; SPI Remap bit position
PORT_USART0_bm = 0x10               ; USART0 Remap bit mask
PORT_USART0_bp = 4                  ; USART0 Remap bit position
...
INT_VECTORS_SIZE = 228 ; size in words
