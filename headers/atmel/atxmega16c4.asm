...
;*
;* Number            : AVR000
;* File Name         : ATxmega16C4def.inc
;* Title             : Register/Bit Definitions for the ATxmega16C4
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega16C4
;*
;* DESCRIPTION
...
PROGMEM_SIZE    =   0x5000
PROGMEM_END     =   0x00000+0x5000-1

APP_SECTION_START   =   0x00000
APP_SECTION_SIZE    =   0x4000
APP_SECTION_END     =   0x00000+0x4000-1

APPTABLE_SECTION_START  =   0x03000
APPTABLE_SECTION_SIZE   =   0x1000
APPTABLE_SECTION_END    =   0x03000+0x1000-1

BOOT_SECTION_START  =   0x04000
BOOT_SECTION_SIZE   =   0x1000
BOOT_SECTION_END    =   0x04000+0x1000-1
