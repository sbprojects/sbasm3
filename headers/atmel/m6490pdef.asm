...
LCDDC0	= 5	; LCD Display Configuration 0
LCDDC1	= 6	; LCD Display Configuration 1
LCDDC2	= 7	; LCD Display Configuration 2
...
; EXTENDED fuse bits
RESERVED	= 0	; Reserved fuse bit, do not program
...
URXCaddr	= 0x001a	; USART, Rx Complete
URXC0addr	= 0x001a	; For compatibility
UDREaddr	= 0x001c	; USART Data register Empty
UDRE0addr	= 0x001c	; For compatibility
...
PCI2addr	= 0x002e	; Pin Change Interrupt Request 2
PCI3addr	= 0x0030	; Pin Change Interrupt Request 3
