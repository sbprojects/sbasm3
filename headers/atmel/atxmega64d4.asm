...
;*
;* Number            : AVR000
;* File Name         : ATxmega64D4def.inc
;* Title             : Register/Bit Definitions for the ATxmega64D4
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega64D4
;*
;* DESCRIPTION
...
; TC1_CTRLB masks
TC1_CCDEN_bm = 0x80 ; Compare or Capture D Enable bit mask
TC1_CCDEN_bp = 7 ; Compare or Capture D Enable bit position
TC1_CCCEN_bm = 0x40 ; Compare or Capture C Enable bit mask
TC1_CCCEN_bp = 6 ; Compare or Capture C Enable bit position
