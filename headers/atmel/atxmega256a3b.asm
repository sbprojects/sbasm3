...
ADCA_CH0_INTCTRL = 546		// Channel Interrupt Control
...
ADCA_CH1_INTCTRL = 554		// Channel Interrupt Control
...
ADCA_CH2_INTCTRL = 562		// Channel Interrupt Control
...
ADCA_CH3_INTCTRL = 570		// Channel Interrupt Control
...
ADCB_CH0_INTCTRL = 610		// Channel Interrupt Control
...
ADCB_CH1_INTCTRL = 618		// Channel Interrupt Control
...
ADCB_CH2_INTCTRL = 626		// Channel Interrupt Control
...
ADCB_CH3_INTCTRL = 634		// Channel Interrupt Control
...
DACB_TIMCTRL = 804		// Timing Control
DACB_STATUS = 805		// Status
DACB_GAINCAL = 808		// Gain Calibration
DACB_OFFSETCAL = 809		// Offset Calibration
...
RTC32_CTRL = 1056		// Control Register
RTC32_SYNCCTRL = 1057		// Synchronization Control/Status Register
RTC32_INTCTRL = 1058		// Interrupt Control Register
RTC32_INTFLAGS = 1059		// Interrupt Flags
RTC32_CNT = 1060		// Count Register
RTC32_PER = 1064		// Period Register
RTC32_COMP = 1068		// Compare Register
...
VBAT_CTRL = 240		// Control Register
VBAT_STATUS = 241		// Status Register
VBAT_BACKUP0 = 242		// Backup Register 0
VBAT_BACKUP1 = 243		// Backup Register 1
...
RTC32_base = 0x0420		// 32-bit Real-Time Counter
...
VBAT_base = 0x0F0		// VBAT Battery Backup Module
...
NVM_PROD_SIGNATURES_DACAOFFCAL_offset = 0x30		// DACA Calibration Byte 0
NVM_PROD_SIGNATURES_DACAGAINCAL_offset = 0x31		// DACA Calibration Byte 1
NVM_PROD_SIGNATURES_DACBOFFCAL_offset = 0x32		// DACB Calibration Byte 0
NVM_PROD_SIGNATURES_DACBGAINCAL_offset = 0x33		// DACB Calibration Byte 1
...
ADC_CH_INTCTRL_offset = 0x02		// Channel Interrupt Control
...
DAC_GAINCAL_offset = 0x08		// Gain Calibration
DAC_OFFSETCAL_offset = 0x09		// Offset Calibration
...
;** RTC32 - 32-bit Real-Time Counter
;***************************************************************************/
RTC32_CTRL_offset = 0x00		// Control Register
RTC32_SYNCCTRL_offset = 0x01		// Synchronization Control/Status Register
RTC32_INTCTRL_offset = 0x02		// Interrupt Control Register
RTC32_INTFLAGS_offset = 0x03		// Interrupt Flags
RTC32_CNT_offset = 0x04		// Count Register
RTC32_PER_offset = 0x08		// Period Register
RTC32_COMP_offset = 0x0C		// Compare Register
...
;***************************************************************************/
VBAT_CTRL_offset = 0x00		// Control Register
VBAT_STATUS_offset = 0x01		// Status Register
VBAT_BACKUP0_offset = 0x02		// Backup Register 0
VBAT_BACKUP1_offset = 0x03		// Backup Register 1
...
ADC_CH_GAINFAC_gm = 0x1C ; Gain Factor group mask
ADC_CH_GAINFAC_gp = 2 ; Gain Factor group position
ADC_CH_GAINFAC0_bm = 1<<2 ; Gain Factor bit 0 mask
ADC_CH_GAINFAC0_bp = 2 ; Gain Factor bit 0 position
ADC_CH_GAINFAC1_bm = 1<<3 ; Gain Factor bit 1 mask
ADC_CH_GAINFAC1_bp = 3 ; Gain Factor bit 1 position
ADC_CH_GAINFAC2_bm = 1<<4 ; Gain Factor bit 2 mask
ADC_CH_GAINFAC2_bp = 4 ; Gain Factor bit 2 position
...
ADC_CH_MUXPOS_gm = 0x78 ; Positive Input Select group mask
ADC_CH_MUXPOS_gp = 3 ; Positive Input Select group position
ADC_CH_MUXPOS0_bm = 1<<3 ; Positive Input Select bit 0 mask
ADC_CH_MUXPOS0_bp = 3 ; Positive Input Select bit 0 position
ADC_CH_MUXPOS1_bm = 1<<4 ; Positive Input Select bit 1 mask
ADC_CH_MUXPOS1_bp = 4 ; Positive Input Select bit 1 position
ADC_CH_MUXPOS2_bm = 1<<5 ; Positive Input Select bit 2 mask
ADC_CH_MUXPOS2_bp = 5 ; Positive Input Select bit 2 position
ADC_CH_MUXPOS3_bm = 1<<6 ; Positive Input Select bit 3 mask
ADC_CH_MUXPOS3_bp = 6 ; Positive Input Select bit 3 position
ADC_CH_MUXINT_gm = 0x78 ; Internal Input Select group mask
ADC_CH_MUXINT_gp = 3 ; Internal Input Select group position
ADC_CH_MUXINT0_bm = 1<<3 ; Internal Input Select bit 0 mask
ADC_CH_MUXINT0_bp = 3 ; Internal Input Select bit 0 position
ADC_CH_MUXINT1_bm = 1<<4 ; Internal Input Select bit 1 mask
ADC_CH_MUXINT1_bp = 4 ; Internal Input Select bit 1 position
ADC_CH_MUXINT2_bm = 1<<5 ; Internal Input Select bit 2 mask
ADC_CH_MUXINT2_bp = 5 ; Internal Input Select bit 2 position
ADC_CH_MUXINT3_bm = 1<<6 ; Internal Input Select bit 3 mask
ADC_CH_MUXINT3_bp = 6 ; Internal Input Select bit 3 position
ADC_CH_MUXNEG_gm = 0x03 ; Negative Input Select group mask
ADC_CH_MUXNEG_gp = 0 ; Negative Input Select group position
ADC_CH_MUXNEG0_bm = 1<<0 ; Negative Input Select bit 0 mask
ADC_CH_MUXNEG0_bp = 0 ; Negative Input Select bit 0 position
ADC_CH_MUXNEG1_bm = 1<<1 ; Negative Input Select bit 1 mask
ADC_CH_MUXNEG1_bp = 1 ; Negative Input Select bit 1 position
...
; DAC_GAINCAL masks
DAC_GAINCAL_gm = 0x7F ; Gain Calibration group mask
DAC_GAINCAL_gp = 0 ; Gain Calibration group position
DAC_GAINCAL0_bm = 1<<0 ; Gain Calibration bit 0 mask
DAC_GAINCAL0_bp = 0 ; Gain Calibration bit 0 position
DAC_GAINCAL1_bm = 1<<1 ; Gain Calibration bit 1 mask
DAC_GAINCAL1_bp = 1 ; Gain Calibration bit 1 position
DAC_GAINCAL2_bm = 1<<2 ; Gain Calibration bit 2 mask
DAC_GAINCAL2_bp = 2 ; Gain Calibration bit 2 position
DAC_GAINCAL3_bm = 1<<3 ; Gain Calibration bit 3 mask
DAC_GAINCAL3_bp = 3 ; Gain Calibration bit 3 position
DAC_GAINCAL4_bm = 1<<4 ; Gain Calibration bit 4 mask
DAC_GAINCAL4_bp = 4 ; Gain Calibration bit 4 position
DAC_GAINCAL5_bm = 1<<5 ; Gain Calibration bit 5 mask
DAC_GAINCAL5_bp = 5 ; Gain Calibration bit 5 position
DAC_GAINCAL6_bm = 1<<6 ; Gain Calibration bit 6 mask
DAC_GAINCAL6_bp = 6 ; Gain Calibration bit 6 position

; DAC_OFFSETCAL masks
DAC_OFFSETCAL_gm = 0x7F ; Offset Calibration group mask
DAC_OFFSETCAL_gp = 0 ; Offset Calibration group position
DAC_OFFSETCAL0_bm = 1<<0 ; Offset Calibration bit 0 mask
DAC_OFFSETCAL0_bp = 0 ; Offset Calibration bit 0 position
DAC_OFFSETCAL1_bm = 1<<1 ; Offset Calibration bit 1 mask
DAC_OFFSETCAL1_bp = 1 ; Offset Calibration bit 1 position
DAC_OFFSETCAL2_bm = 1<<2 ; Offset Calibration bit 2 mask
DAC_OFFSETCAL2_bp = 2 ; Offset Calibration bit 2 position
DAC_OFFSETCAL3_bm = 1<<3 ; Offset Calibration bit 3 mask
DAC_OFFSETCAL3_bp = 3 ; Offset Calibration bit 3 position
DAC_OFFSETCAL4_bm = 1<<4 ; Offset Calibration bit 4 mask
DAC_OFFSETCAL4_bp = 4 ; Offset Calibration bit 4 position
DAC_OFFSETCAL5_bm = 1<<5 ; Offset Calibration bit 5 mask
DAC_OFFSETCAL5_bp = 5 ; Offset Calibration bit 5 position
DAC_OFFSETCAL6_bm = 1<<6 ; Offset Calibration bit 6 mask
DAC_OFFSETCAL6_bp = 6 ; Offset Calibration bit 6 position
...
; RTC32_CTRL masks
RTC32_ENABLE_bm = 0x01 ; RTC enable bit mask
RTC32_ENABLE_bp = 0 ; RTC enable bit position

; RTC32_SYNCCTRL masks
RTC32_SYNCCNT_bm = 0x10 ; Synchronization Busy Flag bit mask
RTC32_SYNCCNT_bp = 4 ; Synchronization Busy Flag bit position
RTC32_SYNCBUSY_bm = 0x01 ; Synchronization Busy Flag bit mask
RTC32_SYNCBUSY_bp = 0 ; Synchronization Busy Flag bit position

; RTC32_INTCTRL masks
RTC32_COMPINTLVL_gm = 0x0C ; Compare Match Interrupt Level group mask
RTC32_COMPINTLVL_gp = 2 ; Compare Match Interrupt Level group position
RTC32_COMPINTLVL0_bm = 1<<2 ; Compare Match Interrupt Level bit 0 mask
RTC32_COMPINTLVL0_bp = 2 ; Compare Match Interrupt Level bit 0 position
RTC32_COMPINTLVL1_bm = 1<<3 ; Compare Match Interrupt Level bit 1 mask
RTC32_COMPINTLVL1_bp = 3 ; Compare Match Interrupt Level bit 1 position
RTC32_OVFINTLVL_gm = 0x03 ; Overflow Interrupt Level group mask
RTC32_OVFINTLVL_gp = 0 ; Overflow Interrupt Level group position
RTC32_OVFINTLVL0_bm = 1<<0 ; Overflow Interrupt Level bit 0 mask
RTC32_OVFINTLVL0_bp = 0 ; Overflow Interrupt Level bit 0 position
RTC32_OVFINTLVL1_bm = 1<<1 ; Overflow Interrupt Level bit 1 mask
RTC32_OVFINTLVL1_bp = 1 ; Overflow Interrupt Level bit 1 position

; RTC32_INTFLAGS masks
RTC32_COMPIF_bm = 0x02 ; Compare Match Interrupt Flag bit mask
RTC32_COMPIF_bp = 1 ; Compare Match Interrupt Flag bit position
RTC32_OVFIF_bm = 0x01 ; Overflow Interrupt Flag bit mask
RTC32_OVFIF_bp = 0 ; Overflow Interrupt Flag bit position
...
; VBAT_CTRL masks
VBAT_HIGHESR_bm = 0x20 ; 32-kHz Crystal Oscillator High Power Mode bit mask
VBAT_HIGHESR_bp = 5 ; 32-kHz Crystal Oscillator High Power Mode bit position
VBAT_XOSCSEL_bm = 0x10 ; 32-kHz Crystal Oscillator Output Selection bit mask
VBAT_XOSCSEL_bp = 4 ; 32-kHz Crystal Oscillator Output Selection bit position
VBAT_XOSCEN_bm = 0x08 ; Crystal Oscillator Enable bit mask
VBAT_XOSCEN_bp = 3 ; Crystal Oscillator Enable bit position
VBAT_XOSCFDEN_bm = 0x04 ; Crystal Oscillator Failure Detection Monitor Enable bit mask
VBAT_XOSCFDEN_bp = 2 ; Crystal Oscillator Failure Detection Monitor Enable bit position
VBAT_ACCEN_bm = 0x02 ; Access Enable bit mask
VBAT_ACCEN_bp = 1 ; Access Enable bit position
VBAT_RESET_bm = 0x01 ; Reset bit mask
VBAT_RESET_bp = 0 ; Reset bit position

; VBAT_STATUS masks
VBAT_BBPWR_bm = 0x80 ; Battery backup Power bit mask
VBAT_BBPWR_bp = 7 ; Battery backup Power bit position
VBAT_XOSCRDY_bm = 0x08 ; Crystal Oscillator Ready bit mask
VBAT_XOSCRDY_bp = 3 ; Crystal Oscillator Ready bit position
VBAT_XOSCFAIL_bm = 0x04 ; Crystal Oscillator Failure bit mask
VBAT_XOSCFAIL_bp = 2 ; Crystal Oscillator Failure bit position
VBAT_BBBORF_bm = 0x02 ; Battery Backup Brown-Out Reset Flag bit mask
VBAT_BBBORF_bp = 1 ; Battery Backup Brown-Out Reset Flag bit position
VBAT_BBPORF_bm = 0x01 ; Battery Backup Power-On Reset Flag bit mask
VBAT_BBPORF_bp = 0 ; Battery Backup Power-On Reset Flag bit position
...
PROGMEM_SIZE    =   0x42000
PROGMEM_END     =   0x00000+0x42000-1

APP_SECTION_START   =   0x00000
APP_SECTION_SIZE    =   0x40000
APP_SECTION_END     =   0x00000+0x40000-1

APPTABLE_SECTION_START  =   0x3E000
APPTABLE_SECTION_SIZE   =   0x2000
APPTABLE_SECTION_END    =   0x3E000+0x2000-1

BOOT_SECTION_START  =   0x40000
BOOT_SECTION_SIZE   =   0x2000
BOOT_SECTION_END    =   0x40000+0x2000-1

EEPROM_START    =   0x00000
EEPROM_SIZE     =   0x1000
EEPROM_END      =   0x00000+0x1000-1

FUSE_START  =   0x00000
FUSE_SIZE   =   0x0006
FUSE_END    =   0x00000+0x0006-1

LOCKBIT_START   =   0x00000
LOCKBIT_SIZE    =   0x0001
LOCKBIT_END     =   0x00000+0x0001-1

SIGNATURES_START    =   0x00000
SIGNATURES_SIZE     =   0x0003
SIGNATURES_END      =   0x00000+0x0003-1

USER_SIGNATURES_START   =   0x00000
USER_SIGNATURES_SIZE    =   0x0200
USER_SIGNATURES_END     =   0x00000+0x0200-1

PROD_SIGNATURES_START   =   0x00000
PROD_SIGNATURES_SIZE    =   0x0034
PROD_SIGNATURES_END     =   0x00000+0x0034-1

DATAMEM_START   =   0x00000
DATAMEM_SIZE    =   0x6000
DATAMEM_END     =   0x00000+0x6000-1

IO_START    =   0x00000
IO_SIZE     =   0x1000
IO_END      =   0x00000+0x1000-1

MAPPED_EEPROM_START     =   0x01000
MAPPED_EEPROM_SIZE      =   0x1000
MAPPED_EEPROM_END       =   0x01000+0x1000-1

INTERNAL_SRAM_START     =   0x02000
INTERNAL_SRAM_SIZE      =   0x4000
INTERNAL_SRAM_END       =   0x02000+0x4000-1
...
RTC32_OVF_vect = 20 ; Overflow Interrupt
RTC32_COMP_vect = 22 ; Compare Interrupt
...
INT_VECTORS_SIZE = 244 ; size in words
