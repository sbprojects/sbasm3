...
;*
;* Number            : AVR000
;* File Name         : ATxmega256A3BUdef.inc
;* Title             : Register/Bit Definitions for the ATxmega256A3BU
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega256A3BU
;*
;* DESCRIPTION
...
MAPPED_EEPROM_END       =   0x1000+0x1000-1
