...
PCI1addr	= 0x0008	; Pin Change Interrupt Request 1
WDTaddr	= 0x000a	; Watchdog Time-Out Interrupt
ICP1addr	= 0x000c	; Timer/Counter1 Capture Event
OC1Aaddr	= 0x000e	; Timer/Counter1 Compare Match 1A
OC1Baddr	= 0x0010	; Timer/Counter1 Compare Match 1B
OVF1addr	= 0x0012	; Timer/Counter1 Overflow
OC0Aaddr	= 0x0014	; Timer/Counter0 Compare Match 0A
OVF0addr	= 0x0016	; Timer/Counter0 Overflow
LIN_TCaddr	= 0x0018	; LIN Transfer Complete
LIN_ERRaddr	= 0x001a	; LIN Error
SPIaddr	= 0x001c	; SPI Serial Transfer Complete
ADCCaddr	= 0x001e	; ADC Conversion Complete
ERDYaddr	= 0x0020	; EEPROM Ready
ACIaddr	= 0x0022	; Analog Comparator
USI_STARTaddr	= 0x0024	; USI Start
USI_OVFaddr	= 0x0026	; USI Overflow

INT_VECTORS_SIZE	= 40	; size in words
