...
SELFPRGEN = 0 ; Added for backwards compatibility
...
PCI0addr	= 0x0006	; Pin Change Interrupt Request 0
PCI1addr	= 0x0008	; Pin Change Interrupt Request 0
PCI2addr	= 0x000a	; Pin Change Interrupt Request 1
WDTaddr	= 0x000c	; Watchdog Time-out Interrupt
OC2Aaddr	= 0x000e	; Timer/Counter2 Compare Match A
OC2Baddr	= 0x0010	; Timer/Counter2 Compare Match A
OVF2addr	= 0x0012	; Timer/Counter2 Overflow
ICP1addr	= 0x0014	; Timer/Counter1 Capture Event
OC1Aaddr	= 0x0016	; Timer/Counter1 Compare Match A
OC1Baddr	= 0x0018	; Timer/Counter1 Compare Match B
OVF1addr	= 0x001a	; Timer/Counter1 Overflow
OC0Aaddr	= 0x001c	; TimerCounter0 Compare Match A
OC0Baddr	= 0x001e	; TimerCounter0 Compare Match B
OVF0addr	= 0x0020	; Timer/Couner0 Overflow
SPIaddr	= 0x0022	; SPI Serial Transfer Complete
URXCaddr	= 0x0024	; USART Rx Complete
UDREaddr	= 0x0026	; USART, Data Register Empty
UTXCaddr	= 0x0028	; USART Tx Complete
...
SPMRaddr	= 0x0032	; Store Program Memory Read

INT_VECTORS_SIZE	= 52	; size in words
