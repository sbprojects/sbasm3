...
SP8	= 0	; Stack pointer bit 8
SP9	= 1	; Stack pointer bit 9
...
OC0Aaddr	= 0x000c	; TimerCounter0 Compare Match A
OC0Baddr	= 0x000d	; TimerCounter0 Compare Match B
OVF0addr	= 0x000e	; Timer/Couner0 Overflow
SPIaddr	= 0x000f	; SPI Serial Transfer Complete
ADCCaddr	= 0x0010	; ADC Conversion Complete
ERDYaddr	= 0x0011	; EEPROM Ready
ACIaddr	= 0x0012	; Analog Comparator
TWIaddr	= 0x0013	; Two-wire Serial Interface

INT_VECTORS_SIZE	= 20	; size in words
