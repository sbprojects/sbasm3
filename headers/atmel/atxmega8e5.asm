...
;*
;* Number            : AVR000
;* File Name         : ATxmega8E5def.inc
;* Title             : Register/Bit Definitions for the ATxmega8E5
;* Created           : 2012-11-02 13:32
;* Version           : 1.00
;* Support e-mail    : avr@atmel.com
;* Target MCU        : ATxmega8E5
;*
;* DESCRIPTION
...
PROGMEM_SIZE    =   0x2800
PROGMEM_END     =   0x0000+0x2800-1

APP_SECTION_START   =   0x0000
APP_SECTION_SIZE    =   0x2000
APP_SECTION_END     =   0x0000+0x2000-1

APPTABLE_SECTION_START  =   0x1800
APPTABLE_SECTION_SIZE   =   0x0800
APPTABLE_SECTION_END    =   0x1800+0x0800-1

BOOT_SECTION_START  =   0x2000
BOOT_SECTION_SIZE   =   0x0800
BOOT_SECTION_END    =   0x2000+0x0800-1

DATAMEM_START   =   0x0000
DATAMEM_SIZE    =   0x2400
DATAMEM_END     =   0x0000+0x2400-1
...
INTERNAL_SRAM_SIZE      =   0x0400
INTERNAL_SRAM_END       =   0x2000+0x0400-1
