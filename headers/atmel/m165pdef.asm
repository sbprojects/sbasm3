...
PCIE0	= 6	; Pin Change Interrupt Enable 0
PCIE1	= 7	; Pin Change Interrupt Enable 1

; EIFR - External Interrupt Flag Register
INTF0	= 0	; External Interrupt Flag 0
PCIF0	= 6	; Pin Change Interrupt Flag 0
PCIF1	= 7	; Pin Change Interrupt Flag 1
...
INT_VECTORS_SIZE	= 44	; size in words
