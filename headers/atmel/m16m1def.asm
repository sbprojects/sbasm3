...
PIFR	= 0xbc	; MEMORY MAPPED
PIM	= 0xbb	; MEMORY MAPPED
PMIC2	= 0xba	; MEMORY MAPPED
PMIC1	= 0xb9	; MEMORY MAPPED
PMIC0	= 0xb8	; MEMORY MAPPED
PCTL	= 0xb7	; MEMORY MAPPED
POC	= 0xb6	; MEMORY MAPPED
PCNF	= 0xb5	; MEMORY MAPPED
PSYNC	= 0xb4	; MEMORY MAPPED
POCR_RBL	= 0xb2	; MEMORY MAPPED
POCR_RBH	= 0xb3	; MEMORY MAPPED
POCR2SBL	= 0xb0	; MEMORY MAPPED
POCR2SBH	= 0xb1	; MEMORY MAPPED
POCR2RAL	= 0xae	; MEMORY MAPPED
POCR2RAH	= 0xaf	; MEMORY MAPPED
POCR2SAL	= 0xac	; MEMORY MAPPED
POCR2SAH	= 0xad	; MEMORY MAPPED
POCR1SBL	= 0xaa	; MEMORY MAPPED
POCR1SBH	= 0xab	; MEMORY MAPPED
POCR1RAL	= 0xa8	; MEMORY MAPPED
POCR1RAH	= 0xa9	; MEMORY MAPPED
POCR1SAL	= 0xa6	; MEMORY MAPPED
POCR1SAH	= 0xa7	; MEMORY MAPPED
POCR0SBL	= 0xa4	; MEMORY MAPPED
POCR0SBH	= 0xa5	; MEMORY MAPPED
POCR0RAL	= 0xa2	; MEMORY MAPPED
POCR0RAH	= 0xa3	; MEMORY MAPPED
POCR0SAL	= 0xa0	; MEMORY MAPPED
POCR0SAH	= 0xa1	; MEMORY MAPPED
...
PEV0	= 1	; PSC External Event 0 Interrupt
PEV1	= 2	; PSC External Event 1 Interrupt
PEV2	= 3	; PSC External Event 2 Interrupt

; PIM - PSC Interrupt Mask Register
PEOPE	= 0	; PSC End of Cycle Interrupt Enable
PEVE0	= 1	; External Event 0 Interrupt Enable
PEVE1	= 2	; External Event 1 Interrupt Enable
PEVE2	= 3	; External Event 2 Interrupt Enable

; PMIC2 - PSC Module 2 Input Control Register
PRFM20	= 0	; PSC Module 2 Input Mode bit 0
PRFM21	= 1	; PSC Module 2 Input Mode bit 1
PRFM22	= 2	; PSC Module 2 Input Mode bit 2
...
PRFM10	= 0	; PSC Module 1 Input Mode bit 0
PRFM11	= 1	; PSC Module 1 Input Mode bit 1
PRFM12	= 2	; PSC Module 1 Input Mode bit 2
...
PRFM00	= 0	; PSC Module 0 Input Mode bit 0
PRFM01	= 1	; PSC Module 0 Input Mode bit 1
PRFM02	= 2	; PSC Module 0 Input Mode bit 2
...
PPRE0	= 6	; PSC Prescaler Select bit 0
PPRE1	= 7	; PSC Prescaler Select bit 1
...
PSYNC00	= 0	; Selection of Synchronization Out for ADC
PSYNC01	= 1	; Selection of Synchronization Out for ADC
PSYNC10	= 2	; Selection of Synchronization Out for ADC
PSYNC11	= 3	; Selection of Synchronization Out for ADC
PSYNC20	= 4	; Selection of Synchronization Out for ADC
PSYNC21	= 5	; Selection of Synchronization Out for ADC
...
NRWW_START_ADDR	= 0x1800
NRWW_STOP_ADDR	= 0x1fff
RWW_START_ADDR	= 0x0
RWW_STOP_ADDR	= 0x17ff
PAGESIZE	= 64
FIRSTBOOTSTART	= 0x1f00
SECONDBOOTSTART	= 0x1e00
THIRDBOOTSTART	= 0x1c00
FOURTHBOOTSTART	= 0x1800
