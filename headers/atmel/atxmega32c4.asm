...
;*
;* Number            : AVR000
;* File Name         : ATxmega32C4def.inc
;* Title             : Register/Bit Definitions for the ATxmega32C4
;* Date              : Jan 01 2008
;* Version           : 1.00
;* Support E-mail    : avr@atmel.com
;* Target MCU        : ATxmega32C4
;*
;* DESCRIPTION
