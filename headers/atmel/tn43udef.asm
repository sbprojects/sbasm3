...
COM1B0	= 4	; Compare Match Output B Mode bit 0
COM1B1	= 5	; Compare Match Output B Mode bit 1
COM1A0	= 6	; Compare Match Output A Mode bit 0
COM1A1	= 7	; Compare Match Output A Mode bit 1
...
ISC00	= 0	; Interrupt Sense Control 0 Bit 1
ISC01	= 1	; Interrupt Sense Control 0 Bit 0
...
MUX1	= 1	; Analog Channel Selection Bit 1
MUX2	= 2	; Analog Channel Selection Bit 2
...
OC1Aaddr	= 0x0005	; Timer/Counter1 Compare Match A
OC1Baddr	= 0x0006	; Timer/Counter1 Compare Match B
OVF1addr	= 0x0007	; Timer/Counter1 Overflow
OC0Aaddr	= 0x0008	; Timer/Counter0 Compare Match A
OC0Baddr	= 0x0009	; Timer/Counter0 Compare Match B
OVF0addr	= 0x000a	; Timer/Counter0 Overflow
ACIaddr	= 0x000b	; Analog Comparator
ADCCaddr	= 0x000c	; ADC Conversion Complete
ERDYaddr	= 0x000d	; EEPROM Ready
USI_STARTaddr	= 0x000e	; USI START
USI_OVFaddr	= 0x000f	; USI Overflow
