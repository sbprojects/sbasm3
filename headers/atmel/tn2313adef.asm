...
UMSEL0 	= 6	; USART Mode Select 0
UMSEL1 	= 7 ; USART Mode Select 1
UCPHA  	= 1 ; USART MSPIM Clock Phase
UDORD  	= 2 ; USART MSPIM Data Order 
...
PCINT11	= 0	; Pin Change Interrupt Mask 11
PCINT12	= 1	; Pin Change Interrupt Mask 12
PCINT13	= 2	; Pin Change Interrupt Mask 13
PCINT14	= 3	; Pin Change Interrupt Mask 14
PCINT15	= 4	; Pin Change Interrupt Mask 15
PCINT16	= 5	; Pin Change Interrupt Mask 16
PCINT17	= 6	; Pin Change Interrupt Mask 17

; PCMSK1 - Pin Change Interrupt Mask Register 1
PCINT8	= 0	; Pin Change Interrupt Mask 8
PCINT9	= 1	; Pin Change Interrupt Mask 9
PCINT10	= 2	; Pin Change Interrupt Mask 10
...
PCIBaddr	= 0x000b	; Pin Change Interrupt Request B
PCIaddr	= 0x000b	; For compatibility
OC1Baddr	= 0x000c	; 
OC0Aaddr	= 0x000d	; 
OC0Baddr	= 0x000e	; 
...
PCIAaddr	= 0x0013	; Pin Change Interrupt Request A
PCIDaddr	= 0x0014	; Pin Change Interrupt Request D
