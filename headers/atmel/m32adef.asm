...
; SFIOR - Special Function IO Register
PSR10	= 0	; Prescaler Reset Timer/Counter1&0
...
SPIaddr	= 0x0018	; Serial Transfer Complete
URXCaddr	= 0x001a	; USART, Rx Complete
UDREaddr	= 0x001c	; USART Data Register Empty
UTXCaddr	= 0x001e	; USART, Tx Complete
ADCCaddr	= 0x0020	; ADC Conversion Complete
ERDYaddr	= 0x0022	; EEPROM Ready
ACIaddr	= 0x0024	; Analog Comparator
TWIaddr	= 0x0026	; 2-wire Serial Interface
