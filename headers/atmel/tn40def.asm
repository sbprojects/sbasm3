...
PCINT12	= 0	; Pin Change Enable Mask 0
PCINT13	= 1	; Pin Change Enable Mask 1
PCINT14	= 2	; Pin Change Enable Mask 2
PCINT15	= 3	; Pin Change Enable Mask 3
PCINT16	= 4	; Pin Change Enable Mask 3
PCINT17	= 5	; Pin Change Enable Mask 3

; PCMSK1 - Pin Change Mask Register 1
PCINT8	= 0	; Pin Change Enable Mask 0
PCINT9	= 1	; Pin Change Enable Mask 1
PCINT10	= 2	; Pin Change Enable Mask 2
PCINT11	= 3	; Pin Change Enable Mask 3
...
PCINT4	= 4	; Pin Change Enable Mask 3
PCINT5	= 5	; Pin Change Enable Mask 3
PCINT6	= 6	; Pin Change Enable Mask 3
PCINT7	= 7	; Pin Change Enable Mask 3
...
CS10	.DE R0	; The Clock Select1 bits 2, 1, and 0 define the prescaling source of Timer1.
PWM10	= CS10	; For compatibility
CS11	.DE R1	; The Clock Select1 bits 2, 1, and 0 define the prescaling source of Timer1.
PWM11	= CS11	; For compatibility
CS12	.DE R2	; The Clock Select1 bits 2, 1, and 0 define the prescaling source of Timer1.
...
MAPPED_FLASH_SIZE	= 0x1000
MAPPED_FLASH_END	= 0x4fff
...
PCI2addr	= 0x0004	; Pin Change Interrupt Request 1
WDTaddr	= 0x0005	; Watchdog Time-out
ICP1addr	= 0x0006	; Timer/Counter1 Input Capture
OC1Aaddr	= 0x0007	; Timer/Counter1 Compare Match A
OC1Baddr	= 0x0008	; Timer/Counter1 Compare Match B
...
OVF0addr	= 0x000c	; Timer/Counter0 Overflow
ACIaddr	= 0x000d	; Analog Comparator
ADCCaddr	= 0x000e	; Conversion Complete
TWIaddr	= 0x000f	; Two-Wire Interface
SPIaddr	= 0x0010	; Serial Peripheral Interface
QTRIPaddr	= 0x0011	; Touch Sensing
