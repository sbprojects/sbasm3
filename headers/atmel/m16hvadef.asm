...
WDTaddr	= 0x000c	; Watchdog Timeout Interrupt
ICP1addr	= 0x000e	; Timer 1 Input capture
OC1Aaddr	= 0x0010	; Timer 1 Compare Match A
OC1Baddr	= 0x0012	; Timer 1 Compare Match B
OVF1addr	= 0x0014	; Timer 1 overflow
ICP0addr	= 0x0016	; Timer 0 Input Capture
OC0Aaddr	= 0x0018	; Timer 0 Comapre Match A
OC0Baddr	= 0x001a	; Timer 0 Compare Match B
OVF0addr	= 0x001c	; Timer 0 Overflow
SPIaddr	= 0x001e	; SPI Serial transfer complete
VADCaddr	= 0x0020	; Voltage ADC Conversion Complete
CADICaddr	= 0x0022	; Coulomb Counter ADC Conversion Complete
CADRCaddr	= 0x0024	; Coloumb Counter ADC Regular Current
CADACaddr	= 0x0026	; Coloumb Counter ADC Accumulator
