...
DACA_GAINCAL = 776		// Gain Calibration
DACA_OFFSETCAL = 777		// Offset Calibration
...
DACA_base = 0x0300		// Digitalto Analog Converter A
...
PROGMEM_END     =   0x0000+0x11000-1

APP_SECTION_START   =   0x0000
APP_SECTION_SIZE    =   0x10000
APP_SECTION_END     =   0x0000+0x10000-1
...
EXTERNAL_SRAM_START     =   0x3000
EXTERNAL_SRAM_SIZE      =   0xFFD000
EXTERNAL_SRAM_END       =   0x3000+0xFFD000-1

EEPROM_START    =   0x0000
EEPROM_SIZE     =   0x0800
EEPROM_END      =   0x0000+0x0800-1
...
INT_VECTORS_SIZE = 250 ; size in words
