...
S8535C	= 7	; AT90S4434/8535 compabillity mode
...
INT1addr	= 0x0002	; External Interrupt 1
...
SPIaddr	= 0x000a	; SPI Serial Transfer Complete
...
TWIaddr	= 0x0011	; Two-wire Serial Interface
INT2addr	= 0x0012	; External Interrupt Request 2
OC0addr	= 0x0013	; TimerCounter0 Compare Match
SPMRaddr	= 0x0014	; Store Program Memory Read
