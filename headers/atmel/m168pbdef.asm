...
BOOTSECTION1START	= 0x1F80 ; Note: Word address
BOOTSECTION1END	= 0x1FFF ; Note: Word address
BOOTSECTION1PAGESIZE	= 0x0080 ;

BOOTSECTION2START	= 0x1F00 ; Note: Word address
BOOTSECTION2END	= 0x1FFF ; Note: Word address
BOOTSECTION2PAGESIZE	= 0x0080 ;

BOOTSECTION3START	= 0x1E00 ; Note: Word address
BOOTSECTION3END	= 0x1FFF ; Note: Word address
BOOTSECTION3PAGESIZE	= 0x0080 ;

BOOTSECTION4START	= 0x1C00 ; Note: Word address
BOOTSECTION4END	= 0x1FFF ; Note: Word address
...
PCINT1addr	 = 0x0008 ; Pin Change Interrupt Request 0
PCINT2addr	 = 0x000A ; Pin Change Interrupt Request 1
WDTaddr	 = 0x000C ; Watchdog Time-out Interrupt
TIMER2_COMPAaddr	 = 0x000E ; Timer/Counter2 Compare Match A
TIMER2_COMPBaddr	 = 0x0010 ; Timer/Counter2 Compare Match A
...
SPI_STCaddr	 = 0x0022 ; SPI Serial Transfer Complete
USART_RXaddr	 = 0x0024 ; USART Rx Complete
USART_UDREaddr	 = 0x0026 ; USART, Data Register Empty
USART_TXaddr	 = 0x0028 ; USART Tx Complete
ADCaddr	 = 0x002A ; ADC Conversion Complete
EE_READYaddr	 = 0x002C ; EEPROM Ready
ANALOG_COMPaddr	 = 0x002E ; Analog Comparator
TWIaddr	 = 0x0030 ; Two-wire Serial Interface
SPM_Readyaddr	 = 0x0032 ; Store Program Memory Read
USART_STARTaddr	 = 0x0034 ; USART Start Edge Interrupt

INT_VECTORS_SIZE	= 54 ; size in words
