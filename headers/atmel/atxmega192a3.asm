...
PROGMEM_SIZE    =   0x32000
PROGMEM_END     =   0x0000+0x32000-1

APP_SECTION_START   =   0x0000
APP_SECTION_SIZE    =   0x30000
APP_SECTION_END     =   0x0000+0x30000-1

APPTABLE_SECTION_START  =   0x2E000
APPTABLE_SECTION_SIZE   =    0x2000
APPTABLE_SECTION_END    =   0x2E000+0x2000-1

BOOT_SECTION_START  =   0x30000
BOOT_SECTION_SIZE   =   0x2000
BOOT_SECTION_END    =   0x30000+0x2000-1
...
MAPPED_EEPROM_SIZE      =   0x800
MAPPED_EEPROM_END       =   0x1000+0x800-1

INTERNAL_SRAM_START     =   0x2000
INTERNAL_SRAM_SIZE      =   0x4000
INTERNAL_SRAM_END       =   0x2000+0x4000-1

EEPROM_START    =   0x0000
EEPROM_SIZE     =   0x800
EEPROM_END      =   0x0000+0x800-1
...
USER_SIGNATURES_END     =   0x0000+0x0200-1
