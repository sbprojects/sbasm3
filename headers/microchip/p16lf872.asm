...
;  MPASM PIC16LF872 processor include
;
...
;  bits of information for the PIC16LF872 microcontroller.  These names
...
_CP_ON               .EQ  $0FCF All memory code protected
_CP_All              .EQ  $0FCF All memory code protected
...
_WRT_ALL             .EQ  $3FFF Unprotected program memory may be written to by EECON control
