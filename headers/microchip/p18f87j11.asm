...
;  MPASM PIC18F87J11 processor include
;
...
;  bits of information for the PIC18F87J11 microcontroller.  These names
...
;     FOSC = EC            EC Oscillator, CLKO  on RA6
;     FOSC = ECPLL         EC Oscillator, PLL enabled, CLKO on RA6
;
...
;     WAIT = ON            Wait states on the external bus are enabled and selected by MEMCON<5:4>
...
;     PMPMX = ALTERNATE    PMP port pins not connected to EMB (PORTA, PORTF and PORTH)
;     PMPMX = DEFAULT      PMP port pins connected to EMB (PORTD and PORTE)
;
