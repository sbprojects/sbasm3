...
;  MPASM PIC18LF6723 processor include
;
...
;  bits of information for the PIC18LF6723 microcontroller.  These names
...
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_PORTE_3H     .EQ  $FE  ECCP2 input/output is multiplexed with RE7
