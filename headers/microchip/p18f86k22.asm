...
;  MPASM PIC18F86K22 processor include
;
...
;  bits of information for the PIC18F86K22 microcontroller.  These names
...
_EASHFT_OFF_3L       .EQ  $F7  Address shifting disabled
_EASHFT_ON_3L        .EQ  $FF  Address shifting enabled

_ABW_XM20_3L         .EQ  $CF  20-bit address bus
_ABW_XM16_3L         .EQ  $DF  16-bit address bus
_ABW_XM12_3L         .EQ  $EF  12-bit address bus
_ABW_MM_3L           .EQ  $FF  8-bit address bus

_BW_8_3L             .EQ  $BF  8-bit external bus mode
_BW_16_3L            .EQ  $FF  16-bit external bus mode

_WAIT_ON_3L          .EQ  $7F  Enabled
_WAIT_OFF_3L         .EQ  $FF  Disabled

;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_PORTBE_3H    .EQ  $FE  RE7-Microcontroller Mode/RB3-All other modes
_CCP2MX_PORTC_3H     .EQ  $FF  RC1

_ECCPMX_PORTH_3H     .EQ  $FD  Enhanced CCP1/3 [P1B/P1C/P3B/P3C] muxed with RH7/RH6/RH5/RH4
_ECCPMX_PORTE_3H     .EQ  $FF  Enhanced CCP1/3 [P1B/P1C/P3B/P3C] muxed with RE6/RE5/RE4/RE3
