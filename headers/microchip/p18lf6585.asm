...
;  MPASM PIC18LF6585 processor include
;
...
;  bits of information for the PIC18LF6585 microcontroller.  These names
...
;----- CONFIG3L Options --------------------------------------------------
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_OFF_3H       .EQ  $FE  CCP2 input/output is multiplexed with RE7
