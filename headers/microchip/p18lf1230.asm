...
;  MPASM PIC18LF1230 processor include
;
...
;  bits of information for the PIC18LF1230 microcontroller.  These names
...
_BBSIZ_BB512_4L      .EQ  $FF  512 Words (1024 Bytes) Boot Block size
