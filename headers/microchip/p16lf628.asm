...
;  MPASM PIC16LF628 processor include
;
...
;  bits of information for the PIC16LF628 microcontroller.  These names
...
_CP_ALL              .EQ  $03FF  0000h-07FFh code protected
_CP_75               .EQ  $17FF  0200h-07FFh code protected
_CP_50               .EQ  $2BFF  0400h-07FFh code protected
