...
;  MPASM PIC18LF6520 processor include
;
...
;  bits of information for the PIC18LF6520 microcontroller.  These names
...
;----- CONFIG3L Options --------------------------------------------------
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_RE7          .EQ  $FE  CCP2 input/output is multiplexed with RE7
_CCP2MX_OFF          .EQ  $FE  CCP2 input/output is multiplexed with RE7
_CCP2MUX_OFF_3H      .EQ  $FE  CCP2 input/output is multiplexed with RE7
_CCP2MX_RE7_3H       .EQ  $FE  CCP2 input/output is multiplexed with RE7
_CCP2MUX_RE7_3H      .EQ  $FE  CCP2 input/output is multiplexed with RE7
