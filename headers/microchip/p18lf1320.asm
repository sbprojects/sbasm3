...
;  MPASM PIC18LF1320 processor include
;
...
;  bits of information for the PIC18LF1320 microcontroller.  These names
...
;
;   Code Protection bit:
;     CP0 = ON             Block 0 (00200-000FFFh) code-protected
;     CP0 = OFF            Block 0 (00200-000FFFh) not code-protected
;
;   Code Protection bit:
...
;     WRT0 = ON            Block 0 (00200-000FFFh) write-protected
;     WRT0 = OFF           Block 0 (00200-000FFFh) not write-protected
;
;   Write Protection bit:
...
;     EBTR0 = ON           Block 0 (00200-000FFFh) protected from table reads executed in other blocks
;     EBTR0 = OFF          Block 0 (00200-000FFFh) not protected from table reads executed in other blocks
;
;   Table Read Protection bit:
...
;----- CONFIG5L Options --------------------------------------------------
_CP0_ON_5L           .EQ  $FE  Block 0 (00200-000FFFh) code-protected
_CP0_OFF_5L          .EQ  $FF  Block 0 (00200-000FFFh) not code-protected
...
;----- CONFIG6L Options --------------------------------------------------
_WRT0_ON_6L          .EQ  $FE  Block 0 (00200-000FFFh) write-protected
_WRT0_OFF_6L         .EQ  $FF  Block 0 (00200-000FFFh) not write-protected
...
;----- CONFIG7L Options --------------------------------------------------
_EBTR0_ON_7L         .EQ  $FE  Block 0 (00200-000FFFh) protected from table reads executed in other blocks
_EBTR0_OFF_7L        .EQ  $FF  Block 0 (00200-000FFFh) not protected from table reads executed in other blocks
