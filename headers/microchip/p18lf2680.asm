...
;  MPASM PIC18LF2680 processor include
;
...
;  bits of information for the PIC18LF2680 microcontroller.  These names
...
_BBSIZ_1024_4L       .EQ  $CF  1K words (2K bytes) Boot Block
_BBSIZ_2048_4L       .EQ  $DF  2K words (4K bytes) Boot Block
_BBSIZ_4096_4L       .EQ  $EF  4K words (8K bytes) Boot Block
