...
;  MPASM PIC16LF767 processor include
;
...
;  bits of information for the PIC16LF767 microcontroller.  These names
...
_CP_ON               .EQ  $1FFF  0000h to 1FFFh code-protected
_CP_ALL              .EQ  $1FFF  0000h to 1FFFh code-protected
