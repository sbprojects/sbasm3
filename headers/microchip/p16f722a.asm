...
;  MPASM PIC16F722A processor include
;
...
;  bits of information for the PIC16F722A microcontroller.  These names
...
_VCAP_RA0            .EQ  $3FCF  VCAP functionality is enabled on RA0
_VCAPEN_RA5          .EQ  $3FDF  VCAP functionality is enabled on RA5
_VCAP_RA5            .EQ  $3FDF  VCAP functionality is enabled on RA5
_VCAPEN_RA6          .EQ  $3FEF  VCAP functionality is enabled on RA6
_VCAP_RA6            .EQ  $3FEF  VCAP functionality is enabled on RA6
_VCAPEN_DIS          .EQ  $3FFF  All VCAP pin functions are disabled
_VCAP_DIS            .EQ  $3FFF  All VCAP pin functions are disabled
