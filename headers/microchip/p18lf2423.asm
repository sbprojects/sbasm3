...
;  MPASM PIC18LF2423 processor include
;
...
;  bits of information for the PIC18LF2423 microcontroller.  These names
...
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_PORTB_3H     .EQ  $FE  CCP2 input/output is multiplexed with RB3
