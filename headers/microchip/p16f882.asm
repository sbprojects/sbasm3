...
;  MPASM PIC16F882 processor include
;
...
;  bits of information for the PIC16F882 microcontroller.  These names
...
_WRT_HALF            .EQ  $39FF  0000h to 03FFh write protected, 0400h to 07FFh may be modified by EECON control
_WRT_1FOURTH         .EQ  $3BFF  0000h to 00FFh write protected, 0100h to 07FFh may be modified by EECON control
