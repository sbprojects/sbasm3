...
;  MPASM PIC18LF4431 processor include
;
...
;  bits of information for the PIC18LF4431 microcontroller.  These names
...
;----- CONFIG3H Options --------------------------------------------------
_FLTAMX_RD4_3H       .EQ  $FE  FLTA input is multiplexed with RD4
_FLTAMX_RC1_3H       .EQ  $FF  FLTA input is multiplexed with RC1

_SSPMX_RD1_3H        .EQ  $FB  SCK/SCL clocks and SDA/SDI data are multiplexed with RD3 and RD2, respectively. SDO output is multiplexed with RD1.
_SSPMX_RC7_3H        .EQ  $FF  SCK/SCL clocks and SDA/SDI data are multiplexed with RC5 and RC4, respectively. SDO output is multiplexed with RC7.

_PWM4MX_RD5_3H       .EQ  $F7  PWM4 output is multiplexed with RD5
_PWM4MX_RB5_3H       .EQ  $FF  PWM4 output is multiplexed with RB5

_EXCLKMX_RD0_3H      .EQ  $EF  TMR0/T5CKI external clock input is multiplexed with RD0
_EXCLKMX_RC3_3H      .EQ  $FF  TMR0/T5CKI external clock input is multiplexed with RC3
...
_CP2_ON_5L           .EQ  $FB  Block 2 (002000-002FFFh) code-protected
_CP2_OFF_5L          .EQ  $FF  Block 2 (002000-002FFFh) not code-protected

_CP3_ON_5L           .EQ  $F7  Block 3 (003000-003FFFh) code-protected
_CP3_OFF_5L          .EQ  $FF  Block 3 (003000-003FFFh) not code-protected
...
_WRT2_ON_6L          .EQ  $FB  Block 2 (002000-002FFFh) write-protected
_WRT2_OFF_6L         .EQ  $FF  Block 2 (002000-002FFFh) not write-protected

_WRT3_ON_6L          .EQ  $F7  Block 3 (003000-003FFFh) write-protected
_WRT3_OFF_6L         .EQ  $FF  Block 3 (003000-003FFFh) not write-protected
...
_EBTR2_ON_7L         .EQ  $FB  Block 2 (002000-002FFFh) protected from table reads executed in other blocks
_EBTR2_OFF_7L        .EQ  $FF  Block 2 (002000-002FFFh) not protected from table reads executed in other blocks

_EBTR3_ON_7L         .EQ  $F7  Block 3 (003000-003FFFh) protected from table reads executed in other blocks
_EBTR3_OFF_7L        .EQ  $FF  Block 3 (003000-003FFFh) not protected from table reads executed in other blocks
