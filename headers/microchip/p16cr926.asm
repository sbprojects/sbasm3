...
;  MPASM PIC16CR926 processor include
;
...
;  bits of information for the PIC16CR926 microcontroller.  These names
...
_CP_ALL              .EQ  $3FCF  All memory is code protected
_CP_75               .EQ  $3FDF  0000h-1EFFh code protected
_CP_50               .EQ  $3FEF  0000h-0FFFh code protected
