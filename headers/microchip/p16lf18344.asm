...
;  MPASM PIC16LF18344 processor include
;
...
;  bits of information for the PIC16LF18344 microcontroller.  These names
...
;----- CONFIG3 Options --------------------------------------------------
_WRT_ALL             .EQ  $3FFC  0000h to 0FFFh write protected, no addresses may be modified
_WRT_HALF            .EQ  $3FFD  0000h to 03FFh write-protected, 0400h to 0FFFh may be modified
_WRT_BOOT            .EQ  $3FFE  0000h to 01FFh write-protected, 0200h to 0FFFh may be modified
