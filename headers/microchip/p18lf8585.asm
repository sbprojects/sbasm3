...
;  MPASM PIC18LF8585 processor include
;
...
;  bits of information for the PIC18LF8585 microcontroller.  These names
...
_ECCPMX_PORTH_3H     .EQ  $FD  P1B, P1C are multiplexed with RH7, RH6
_ECCPMX_PORTE_3H     .EQ  $FF  P1B, P1C are multiplexed with RE6, RE5
