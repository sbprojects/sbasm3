...
;  MPASM PIC16C71 processor include
;
...
;  bits of information for the PIC16C71 microcontroller.  These names
...
_PWRTE_OFF           .EQ  $3FF7 PWRT disabled
_PWRTE_ON            .EQ  $3FFF PWRT enabled

_CP_ON               .EQ  $3FEF Code protection on
