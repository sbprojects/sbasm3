...
;  MPASM PIC18C252 processor include
;
...
;  bits of information for the PIC18C252 microcontroller.  These names
...
_HSPLL_OSC_1         .EQ  $FE  HS oscillator with PLL enabled/Clock frequency = (4 x FOSC)
...
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_OFF_5        .EQ  $FE  CCP2 input/output is multiplexed with RB3
_CCP2MX_ON_5         .EQ  $FF  CCP2 input/output is multiplexed with RC1
