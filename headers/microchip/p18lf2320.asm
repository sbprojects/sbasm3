...
;  MPASM PIC18LF2320 processor include
;
...
;  bits of information for the PIC18LF2320 microcontroller.  These names
...
;     CP2 = OFF            Block 2 (001000-0017FFh) not code-protected
;
;   Code Protection bit:
;     CP3 = ON             Block 3 (001800-001FFFh) code-protected
;     CP3 = OFF            Block 3 (001800-001FFFh) not code-protected
;
...
;     WRT2 = OFF           Block 2 (001000-0017FFh) not write-protected
;
;   Write Protection bit:
;     WRT3 = ON            Block 3 (001800-001FFFh) write-protected
;     WRT3 = OFF           Block 3 (001800-001FFFh) not write-protected
;
...
;     EBTR2 = OFF          Block 2 (001000-0017FFh) not protected from table reads executed in other blocks
;
;   Table Read Protection bit:
;     EBTR3 = ON           Block 3 (001800-001FFFh) protected from table reads executed in other blocks
;     EBTR3 = OFF          Block 3 (001800-001FFFh) not protected from table reads executed in other blocks
;
...
;----- CONFIG1H Options --------------------------------------------------
_LP_OSC              .EQ  $F0  LP Oscillator
_LP_OSC_1H           .EQ  $F0  LP Oscillator
_XT_OSC              .EQ  $F1  XT Oscillator
_XT_OSC_1H           .EQ  $F1  XT Oscillator
_HS_OSC              .EQ  $F2  HS Oscillator
_HS_OSC_1H           .EQ  $F2  HS Oscillator
_EC_OSC              .EQ  $F4  EC oscillator, CLKO function on RA6
_EC_OSC_1H           .EQ  $F4  EC oscillator, CLKO function on RA6
_ECIOP_OSC           .EQ  $F5  EC oscillator, port function on RA6
_ECIOP_OSC_1H        .EQ  $F5  EC oscillator, port function on RA6
_ECIO_OSC_1H         .EQ  $F5  EC oscillator, port function on RA6
_HSPLL_OSC           .EQ  $F6  HS oscillator, PLL enabled (clock frequency = 4 x FOSC1)
_HSPLL_OSC_1H        .EQ  $F6  HS oscillator, PLL enabled (clock frequency = 4 x FOSC1)
_RCIO_OSC            .EQ  $F7  External RC oscillator, port function on RA6
_RCIO_OSC_1H         .EQ  $F7  External RC oscillator, port function on RA6
_INTIO2_OSC          .EQ  $F8  Internal RC oscillator, port function on RA6 and port function on RA7
_INTIO2_OSC_1H       .EQ  $F8  Internal RC oscillator, port function on RA6 and port function on RA7
_INTIO1_OSC          .EQ  $F9  Internal RC oscillator, CLKO function on RA6 and port function on RA7
_INTIO1_OSC_1H       .EQ  $F9  Internal RC oscillator, CLKO function on RA6 and port function on RA7
_RC_OSC              .EQ  $FC  External RC oscillator, CLKO function on RA6
...
_CCP2MX_B3           .EQ  $FE  CCP2 input/output is multiplexed with RB3
_CCP2MX_B3_3H        .EQ  $FE  CCP2 input/output is multiplexed with RB3
_CCP2MX_ON           .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MX_ON_3H        .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MX_C1           .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MX_C1_3H        .EQ  $FF  CCP2 input/output is multiplexed with RC1

_PBAD_DIG_3H         .EQ  $FD  PORTB<4:0> pins are configured as digital I/O on Reset
_PBAD_ANA_3H         .EQ  $FF  PORTB<4:0> pins are configured as analog input channels on Reset

_MCLRE_OFF_3H        .EQ  $7F  MCLR disabled; RE3 input is enabled in 40-pin devices only (PIC18F4X20)
...
;----- CONFIG5L Options --------------------------------------------------
_CP0_ON_5L           .EQ  $FE  Block 0 (000200-0007FFh) code-protected
_CP0_OFF_5L          .EQ  $FF  Block 0 (000200-0007FFh) not code-protected

_CP1_ON_5L           .EQ  $FD  Block 1 (000800-000FFFh) code-protected
_CP1_OFF_5L          .EQ  $FF  Block 1 (000800-000FFFh) not code-protected

_CP2_ON_5L           .EQ  $FB  Block 2 (001000-0017FFh) code-protected
_CP2_OFF_5L          .EQ  $FF  Block 2 (001000-0017FFh) not code-protected

_CP3_ON_5L           .EQ  $F7  Block 3 (001800-001FFFh) code-protected
_CP3_OFF_5L          .EQ  $FF  Block 3 (001800-001FFFh) not code-protected

;----- CONFIG5H Options --------------------------------------------------
_CPB_ON_5H           .EQ  $BF  Boot block (000000-0001FFh) is code-protected
_CPB_OFF_5H          .EQ  $FF  Boot block (000000-0001FFh) is not code-protected

_CPD_ON_5H           .EQ  $7F  Data EEPROM is code-protected
_CPD_OFF_5H          .EQ  $FF  Data EEPROM is not code-protected

;----- CONFIG6L Options --------------------------------------------------
_WRT0_ON_6L          .EQ  $FE  Block 0 (000200-0007FFh) write-protected
_WRT0_OFF_6L         .EQ  $FF  Block 0 (000200-0007FFh) not write-protected

_WRT1_ON_6L          .EQ  $FD  Block 1 (000800-000FFFh) write-protected
_WRT1_OFF_6L         .EQ  $FF  Block 1 (000800-000FFFh) not write-protected

_WRT2_ON_6L          .EQ  $FB  Block 2 (001000-0017FFh) write-protected
_WRT2_OFF_6L         .EQ  $FF  Block 2 (001000-0017FFh) not write-protected

_WRT3_ON_6L          .EQ  $F7  Block 3 (001800-001FFFh) write-protected
_WRT3_OFF_6L         .EQ  $FF  Block 3 (001800-001FFFh) not write-protected
...
_WRTB_ON_6H          .EQ  $BF  Boot block (000000-0001FFh) is write-protected
_WRTB_OFF_6H         .EQ  $FF  Boot block (000000-0001FFh) is not write-protected

_WRTD_ON_6H          .EQ  $7F  Data EEPROM is write-protected
_WRTD_OFF_6H         .EQ  $FF  Data EEPROM is not write-protected

;----- CONFIG7L Options --------------------------------------------------
_EBTR0_ON_7L         .EQ  $FE  Block 0 (000200-0007FFh) protected from table reads executed in other blocks
_EBTR0_OFF_7L        .EQ  $FF  Block 0 (000200-0007FFh) not protected from table reads executed in other blocks
...
_EBTR2_ON_7L         .EQ  $FB  Block 2 (001000-0017FFh) protected from table reads executed in other blocks
_EBTR2_OFF_7L        .EQ  $FF  Block 2 (001000-0017FFh) not protected from table reads executed in other blocks

_EBTR3_ON_7L         .EQ  $F7  Block 3 (001800-001FFFh) protected from table reads executed in other blocks
_EBTR3_OFF_7L        .EQ  $FF  Block 3 (001800-001FFFh) not protected from table reads executed in other blocks

;----- CONFIG7H Options --------------------------------------------------
_EBTRB_ON_7H         .EQ  $BF  Boot block (000000-0001FFh) is protected from table reads executed in other blocks
_EBTRB_OFF_7H        .EQ  $FF  Boot block (000000-0001FFh) is not protected from table reads executed in other blocks
