...
;  MPASM PIC16LF18313 processor include
;
...
;  bits of information for the PIC16LF18313 microcontroller.  These names
...
_WDTE_SLEEP          .EQ  $3FFB  WDT enabled while running and disabled while in SLEEP/IDLE  SWDTEN is ignored
...
_LVP_OFF             .EQ  $1FFF  HV on MCLR/VPP must be used for programming.
