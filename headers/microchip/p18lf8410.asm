...
;  MPASM PIC18LF8410 processor include
;
...
;  bits of information for the PIC18LF8410 microcontroller.  These names
...
;----- CONFIG3L Options --------------------------------------------------
_PM_EM_3L            .EQ  $FC  Extended Microcontroller mode
_PM_MPB_3L           .EQ  $FD  Microprocessor with Boot Block mode
_PM_MP_3L            .EQ  $FE  Microprocessor mode
_PM_MC_3L            .EQ  $FF  Microcontroller mode

_BW_8_3L             .EQ  $BF  8-bit External Bus Data Width
_BW_16_3L            .EQ  $FF  16-bit External Bus Data Width

_WAIT_ON_3L          .EQ  $7F  Wait programmed by WAIT1 and WAIT0 bits of MEMCOM register (MEMCOM<5:4>)
_WAIT_OFF_3L         .EQ  $FF  Wait selections unavailable, device will not wait

;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_PORTBE_3H    .EQ  $FE  CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
...
;----- CONFIG5L Options --------------------------------------------------
_CP_ON_5L            .EQ  $FE  Program memory block code-protected
_CP_OFF_5L           .EQ  $FF  Program memory block not code-protected

;----- CONFIG7L Options --------------------------------------------------
_EBTR_ON_7L          .EQ  $FE  Internal program memory block protected from table reads executed from external memory block
_EBTR_OFF_7L         .EQ  $FF  Internal program memory block not protected from table reads executed from external memory block
