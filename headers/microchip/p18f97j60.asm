...
;  MPASM PIC18F97J60 processor include
;
...
;  bits of information for the PIC18F97J60 microcontroller.  These names
...
;     WAIT = ON            Wait states for operations on external memory bus enabled and selected by MEMCON<5:4>
