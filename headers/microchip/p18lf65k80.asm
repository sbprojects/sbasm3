...
;  MPASM PIC18LF65K80 processor include
;
...
;  bits of information for the PIC18LF65K80 microcontroller.  These names
...
;
;   ECAN Mux bit:
;     CANMX = PORTE        ECAN TX and RX pins are located on RE5 and RE4, respectively
;     CANMX = PORTB        ECAN TX and RX pins are located on RB2 and RB3, respectively
;
;   Timer0 Clock Input Mux bit:
;     T0CKMX = PORTG       Timer0 gets its clock input from the RG4/T0CKI pin on 64-pin packages
;     T0CKMX = PORTB       Timer0 gets its clock input from the RB5/T0CKI pin on 64-pin packages
;
;   Timer3 Clock Input Mux bit:
;     T3CKMX = PORTB       Timer3 gets its clock input from the RB5/T3CKI pin on 64-pin packages
...
;----- CONFIG3H Options --------------------------------------------------
_CANMX_PORTE_3H      .EQ  $FE  ECAN TX and RX pins are located on RE5 and RE4, respectively
_CANMX_PORTB_3H      .EQ  $FF  ECAN TX and RX pins are located on RB2 and RB3, respectively

_T0CKMX_PORTG_3H     .EQ  $FD  Timer0 gets its clock input from the RG4/T0CKI pin on 64-pin packages
_T0CKMX_PORTB_3H     .EQ  $FF  Timer0 gets its clock input from the RB5/T0CKI pin on 64-pin packages

_T3CKMX_PORTB_3H     .EQ  $FB  Timer3 gets its clock input from the RB5/T3CKI pin on 64-pin packages
_T3CKMX_PORTG_3H     .EQ  $FF  Timer3 gets its clock input from the RG2/T3CKI pin on 64-pin packages
