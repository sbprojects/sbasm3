...
;  MPASM PIC16LF18876 processor include
;
...
;  bits of information for the PIC16LF18876 microcontroller.  These names
...
_RSTOSC_HFINT32      .EQ  $3F8F  HFINTOSC with OSCFRQ = 32MHz and CDIV = 1:1
_RSTOSC_HFINTPLL     .EQ  $3F9F  HFINTOSC with 2x PLL and OSCFRQ = 16MHz and CDIV=1:1 (FOSC=32 MHz)
