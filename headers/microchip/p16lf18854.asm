...
;  MPASM PIC16LF18854 processor include
;
...
;  bits of information for the PIC16LF18854 microcontroller.  These names
...
;----- CONFIG4 Options --------------------------------------------------
_WRT_ON              .EQ  $3FFC  0x0000 to 0x0FFF write protected
_WRT_WRT_lower       .EQ  $3FFD  0x0000 to x07FF write protected
