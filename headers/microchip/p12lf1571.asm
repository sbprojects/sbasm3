...
;  MPASM PIC12LF1571 processor include
;
...
;  bits of information for the PIC12LF1571 microcontroller.  These names
...
;----- CONFIG2 Options --------------------------------------------------
_WRT_ALL             .EQ  $3FFC  000h to 3FFh write protected, no addresses may be modified by EECON control
