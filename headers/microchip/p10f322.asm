...
_WRT_ALL      .EQ  $27FF  000h to 1FFh write protected, no addresses may be modified by PMCON control
_WRT_HALF     .EQ  $2FFF  000h to 0FFh write protected, 100h to 1FFh may be modified by PMCON control
_WRT_BOOT     .EQ  $37FF  000h to 07Fh write protected, 080h to 1FFh may be modified by PMCON control
