...
;  MPASM PIC18LF25K22 processor include
;
...
;  bits of information for the PIC18LF25K22 microcontroller.  These names
...
_PRICLKEN_OFF_1H     .EQ  $DF  Primary clock disabled
...
_CCP3MX_PORTC6_3H    .EQ  $FB  P3A/CCP3 input/output is mulitplexed with RC6
...
_P2BMX_PORTB5_3H     .EQ  $FF  P2B is on RB5
