...
;  MPASM PIC16LF18857 processor include
;
...
;  bits of information for the PIC16LF18857 microcontroller.  These names
...
;----- CONFIG4 Options --------------------------------------------------
_WRT_ON              .EQ  $3FFC  0x0000 to 0x7FFF write protected
_WRT_WRT_lower       .EQ  $3FFD  0x0000 to x3FFF write protected
