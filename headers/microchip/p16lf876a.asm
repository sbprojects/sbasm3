...
;  MPASM PIC16LF876A processor include
;
...
;  bits of information for the PIC16LF876A microcontroller.  These names
...
_WRT_HALF            .EQ  $39FF 0000h to 0FFFh write-protected; 1000h to 1FFFh may be written to by EECON control
_WRT_1FOURTH         .EQ  $3BFF 0000h to 07FFh write-protected; 0800h to 1FFFh may be written to by EECON control
_WRT_256             .EQ  $3DFF 0000h to 00FFh write-protected; 0100h to 1FFFh may be written to by EECON control
