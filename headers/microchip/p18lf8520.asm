...
;  MPASM PIC18LF8520 processor include
;
...
;  bits of information for the PIC18LF8520 microcontroller.  These names
...
_OSC_LP_1H           .EQ  $F8  LP oscillator
_XT_OSC              .EQ  $F9  XT oscillator
_OSC_XT_1H           .EQ  $F9  XT oscillator
_HS_OSC              .EQ  $FA  HS oscillator
_OSC_HS_1H           .EQ  $FA  HS oscillator
_RC_OSC              .EQ  $FB  RC oscillator w/ OSC2 configured as divide-by-4 clock output
_OSC_RC_1H           .EQ  $FB  RC oscillator w/ OSC2 configured as divide-by-4 clock output
_EC_OSC              .EQ  $FC  EC oscillator w/ OSC2 configured as divide-by-4 clock output
_OSC_EC_1H           .EQ  $FC  EC oscillator w/ OSC2 configured as divide-by-4 clock output
_ECIO_OSC            .EQ  $FD  EC oscillator w/ OSC2 configured as RA6
_OSC_ECIO_1H         .EQ  $FD  EC oscillator w/ OSC2 configured as RA6
_HSPLL_OSC           .EQ  $FE  HS oscillator with PLL enabled; clock frequency = (4 x FOSC)
_OSC_HSPLL_1H        .EQ  $FE  HS oscillator with PLL enabled; clock frequency = (4 x FOSC)
_RCIO_OSC            .EQ  $FF  RC oscillator w/ OSC2 configured as RA6
_OSC_RCIO_1H         .EQ  $FF  RC oscillator w/ OSC2 configured as RA6
...
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_RE7          .EQ  $FE  CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
...
_CCP2MUX_OFF_3H      .EQ  $FE  CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
_CCP2MX_RE7_3H       .EQ  $FE  CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
_CCP2MUX_RE7_3H      .EQ  $FE  CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
_CCP2MX_RC1          .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MX_ON           .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MUX_ON_3H       .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MX_RC1_3H       .EQ  $FF  CCP2 input/output is multiplexed with RC1
_CCP2MUX_RC1_3H      .EQ  $FF  CCP2 input/output is multiplexed with RC1
