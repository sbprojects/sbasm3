...
;  MPASM PIC16LF874A processor include
;
...
;  bits of information for the PIC16LF874A microcontroller.  These names
...
_CPD_ON              .EQ  $3EFF Data EEPROM code-protected
_CPD_OFF             .EQ  $3FFF Data EEPROM code protection off

_WRT_HALF            .EQ  $39FF 0000h to 07FFh write-protected; 0800h to 0FFFh may be written to by EECON control
_WRT_1FOURTH         .EQ  $3BFF 0000h to 03FFh write-protected; 0400h to 0FFFh may be written to by EECON control
_WRT_256             .EQ  $3DFF 0000h to 00FFh write-protected; 0100h to 0FFFh may be written to by EECON control
_WRT_OFF             .EQ  $3FFF Write protection off; all program memory may be written to by EECON control
...
_CP_ON               .EQ  $1FFF All program memory code-protected
_CP_ALL              .EQ  $1FFF All program memory code-protected
