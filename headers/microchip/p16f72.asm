...
;  MPASM PIC16F72 processor include
;
...
;  bits of information for the PIC16F72 microcontroller.  These names
...
_WDTEN_OFF           .EQ  $3FFB  WDT disabled
...
_PWRTE_ON            .EQ  $3FF7  PWRT enabled
_PWRTEN_ON           .EQ  $3FF7  PWRT enabled
_PWRTE_OFF           .EQ  $3FFF  PWRT disabled
_PWRTE_OFF           .EQ  $3FFF  PWRT disabled
_PWRTEN_OFF          .EQ  $3FFF  PWRT disabled

_CP_ON               .EQ  $3FEF  All Memory locations code protected
_CP_ALL              .EQ  $3FEF  All Memory locations code protected
