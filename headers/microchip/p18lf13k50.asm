...
;  MPASM PIC18LF13K50 processor include
;
...
;  bits of information for the PIC18LF13K50 microcontroller.  These names
...
_BBSIZ_OFF_4L        .EQ  $F7  512W boot block size
_BBSIZ_ON_4L         .EQ  $FF  1kW boot block size
