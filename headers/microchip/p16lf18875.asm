...
;  MPASM PIC16LF18875 processor include
;
...
;  bits of information for the PIC16LF18875 microcontroller.  These names
...
;----- ZCD1CON Bits -----------------------------------------------------
INTN_ZCD1CON     .EQ  $0000
INTP_ZCD1CON     .EQ  $0001
POL_ZCD1CON      .EQ  $0004
OUT_ZCD1CON      .EQ  $0005
EN               .EQ  $0007
...
_ZCDDIS_ON           .EQ  $3BFF  Zero-cross detect circuit is always enabled
_ZCDDIS_OFF          .EQ  $3FFF  Zero-cross detect circuit is disabled at POR.
