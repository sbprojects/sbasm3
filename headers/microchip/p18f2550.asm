...
;  MPASM PIC18F2550 processor include
;
...
_BORV_0_2L           .EQ  $E7  Maximum setting 4.59V
_BORV_1_2L           .EQ  $EF  Setting 2 4.33V
_BORV_2_2L           .EQ  $F7  Setting 1 2.79V
_BORV_3_2L           .EQ  $FF  Minimum setting 2.05V
...
;----- CONFIG5L Options --------------------------------------------------
_CP0_ON_5L           .EQ  $FE  Block 0 (000800-001FFFh) is code-protected
_CP0_OFF_5L          .EQ  $FF  Block 0 (000800-001FFFh) is not code-protected

_CP1_ON_5L           .EQ  $FD  Block 1 (002000-003FFFh) is code-protected
_CP1_OFF_5L          .EQ  $FF  Block 1 (002000-003FFFh) is not code-protected

_CP2_ON_5L           .EQ  $FB  Block 2 (004000-005FFFh) is code-protected
_CP2_OFF_5L          .EQ  $FF  Block 2 (004000-005FFFh) is not code-protected

_CP3_ON_5L           .EQ  $F7  Block 3 (006000-007FFFh) is code-protected
_CP3_OFF_5L          .EQ  $FF  Block 3 (006000-007FFFh) is not code-protected

;----- CONFIG5H Options --------------------------------------------------
_CPB_ON_5H           .EQ  $BF  Boot block (000000-0007FFh) is code-protected
_CPB_OFF_5H          .EQ  $FF  Boot block (000000-0007FFh) is not code-protected

_CPD_ON_5H           .EQ  $7F  Data EEPROM is code-protected
_CPD_OFF_5H          .EQ  $FF  Data EEPROM is not code-protected

;----- CONFIG6L Options --------------------------------------------------
_WRT0_ON_6L          .EQ  $FE  Block 0 (000800-001FFFh) is write-protected
_WRT0_OFF_6L         .EQ  $FF  Block 0 (000800-001FFFh) is not write-protected
...
_WRT2_ON_6L          .EQ  $FB  Block 2 (004000-005FFFh) is write-protected
_WRT2_OFF_6L         .EQ  $FF  Block 2 (004000-005FFFh) is not write-protected

_WRT3_ON_6L          .EQ  $F7  Block 3 (006000-007FFFh) is write-protected
_WRT3_OFF_6L         .EQ  $FF  Block 3 (006000-007FFFh) is not write-protected
...
_WRTB_ON_6H          .EQ  $BF  Boot block (000000-0007FFh) is write-protected
_WRTB_OFF_6H         .EQ  $FF  Boot block (000000-0007FFh) is not write-protected

_WRTD_ON_6H          .EQ  $7F  Data EEPROM is write-protected
_WRTD_OFF_6H         .EQ  $FF  Data EEPROM is not write-protected

;----- CONFIG7L Options --------------------------------------------------
_EBTR0_ON_7L         .EQ  $FE  Block 0 (000800-001FFFh) is protected from table reads executed in other blocks
_EBTR0_OFF_7L        .EQ  $FF  Block 0 (000800-001FFFh) is not protected from table reads executed in other blocks
...
_EBTR2_ON_7L         .EQ  $FB  Block 2 (004000-005FFFh) is protected from table reads executed in other blocks
_EBTR2_OFF_7L        .EQ  $FF  Block 2 (004000-005FFFh) is not protected from table reads executed in other blocks

_EBTR3_ON_7L         .EQ  $F7  Block 3 (006000-007FFFh) is protected from table reads executed in other blocks
_EBTR3_OFF_7L        .EQ  $FF  Block 3 (006000-007FFFh) is not protected from table reads executed in other blocks

;----- CONFIG7H Options --------------------------------------------------
_EBTRB_ON_7H         .EQ  $BF  Boot block (000000-0007FFh) is protected from table reads executed in other blocks
_EBTRB_OFF_7H        .EQ  $FF  Boot block (000000-0007FFh) is not protected from table reads executed in other blocks
