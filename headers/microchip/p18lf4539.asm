...
;  MPASM PIC18LF4539 processor include
;
...
;  bits of information for the PIC18LF4539 microcontroller.  These names
...
;     WRT0 = ON            Block 0 (000200h-001FFFh) write protected
;     WRT0 = OFF           Block 0 (000200h-001FFFh) not write protected
;
;   Write Protection bit:
...
;     EBTR0 = ON           Block 0 (000200h-001FFFh) protected from Table Reads executed in other blocks
;     EBTR0 = OFF          Block 0 (000200h-001FFFh) not protected from Table Reads executed in other blocks
;
;   Table Read Protection bit:
...
;----- CONFIG6L Options --------------------------------------------------
_WRT0_ON_6L          .EQ  $FE  Block 0 (000200h-001FFFh) write protected
_WRT0_OFF_6L         .EQ  $FF  Block 0 (000200h-001FFFh) not write protected
...
;----- CONFIG7L Options --------------------------------------------------
_EBTR0_ON_7L         .EQ  $FE  Block 0 (000200h-001FFFh) protected from Table Reads executed in other blocks
_EBTR0_OFF_7L        .EQ  $FF  Block 0 (000200h-001FFFh) not protected from Table Reads executed in other blocks
