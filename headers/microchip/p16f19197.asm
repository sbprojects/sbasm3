...
;  MPASM PIC16F19197 processor include
;
...
;  bits of information for the PIC16F19197 microcontroller.  These names
...
;----- CONFIG1 Options --------------------------------------------------
_FEXTOSC_OFF_4       .EQ  $3FF8  Oscillator not enabled
_FEXTOSC_OFF_3       .EQ  $3FF9  Oscillator not enabled
_FEXTOSC_OFF_2       .EQ  $3FFA  Oscillator not enabled
_FEXTOSC_OFF_1       .EQ  $3FFB  Oscillator not enabled
_FEXTOSC_OFF_0       .EQ  $3FFC  Oscillator not enabled
...
;----- CONFIG4 Options --------------------------------------------------
_WRT_ON              .EQ  $3FFC  0x0000 to 0x1FFF write protected
_WRT_WRT_lower       .EQ  $3FFD  0x0000 to x0FFF write protected
...
_CPD_ON              .EQ  $3FFD  DataNVM code protection enabled
_CPD_OFF             .EQ  $3FFF  DataNVM code protection disabled
