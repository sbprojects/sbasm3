...
;  MPASM PIC18F26K20 processor include
;
...
;  bits of information for the PIC18F26K20 microcontroller.  These names
...
_FOSC_RC_1H          .EQ  $F3  External RC oscillator, CLKOUT function on RA6
_FOSC_EC_1H          .EQ  $F4  EC oscillator, CLKOUT function on RA6
_FOSC_ECIO6_1H       .EQ  $F5  EC oscillator, port function on RA6
_FOSC_HSPLL_1H       .EQ  $F6  HS oscillator, PLL enabled (Clock Frequency = 4 x FOSC1)
_FOSC_RCIO6_1H       .EQ  $F7  External RC oscillator, port function on RA6
_FOSC_INTIO67_1H     .EQ  $F8  Internal oscillator block, port function on RA6 and RA7
_FOSC_INTIO7_1H      .EQ  $F9  Internal oscillator block, CLKOUT function on RA6, port function on RA7
...
_BORV_18_2L          .EQ  $FF  VBOR set to 1.8 V nominal
...
_WRT3_ON_6L          .EQ  $F7  Block 3 (00C000h-00FFFFh) write-protected
_WRT3_OFF_6L         .EQ  $FF  Block 3 (00C000h-00FFFFh) not write-protected
