...
;  MPASM PIC16LF84A processor include
;
...
;  bits of information for the PIC16LF84A microcontroller.  These names
...
_PWRTE_ON            .EQ  $3FF7  Power-up Timer is enabled
_PWRTE_OFF           .EQ  $3FFF  Power-up Timer is disabled

_CP_ON               .EQ  $000F  All program memory is code protected
_CP_OFF              .EQ  $3FFF  Code protection disabled
