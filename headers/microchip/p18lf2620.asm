...
;  MPASM PIC18LF2620 processor include
;
...
;  bits of information for the PIC18LF2620 microcontroller.  These names
...
_OSC_EC_1H           .EQ  $F4  EC oscillator, CLKOUT function on RA6
...
_OSC_INTIO7_1H       .EQ  $F9  Internal oscillator block, CLKOUT function on RA6, port function on RA7
