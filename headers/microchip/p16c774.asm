...
;  MPASM PIC16C774 processor include
;
...
;  bits of information for the PIC16C774 microcontroller.  These names
...
_CP_ALL              .EQ  $0CCF  All memory is code protected
_CP_75               .EQ  $1DDF  0400h-0FFFh code protected
_CP_50               .EQ  $2EEF  0800h-0FFFh code protected
