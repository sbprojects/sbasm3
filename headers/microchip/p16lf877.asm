...
;  MPASM PIC16LF877 processor include
;
...
;  bits of information for the PIC16LF877 microcontroller.  These names
...
_CP_ALL              .EQ  $0FCF 0000h to 1FFFh code protected
_CP_HALF             .EQ  $1FDF 1000h to 1FFFh code protected
_CP_UPPER_256        .EQ  $2FEF 1F00h to 1FFFh code protected
