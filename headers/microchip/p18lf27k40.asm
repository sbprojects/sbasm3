...
;  MPASM PIC18LF27K40 processor include
;
...
;  bits of information for the PIC18LF27K40 microcontroller.  These names
...
;
;   Write Protection Block 3:
;     WRT6 = ON            Block 6 (018000-01BFFFh) write-protected
...
;----- CONFIG4L Options --------------------------------------------------
_WRT0_ON_4L          .EQ  $FE  Block 0 (000800-003FFFh) write-protected
_WRT0_OFF_4L         .EQ  $FF  Block 0 (000800-003FFFh) not write-protected

_WRT1_ON_4L          .EQ  $FD  Block 1 (004000-007FFFh) write-protected
_WRT1_OFF_4L         .EQ  $FF  Block 1 (004000-007FFFh) not write-protected

_WRT2_ON_4L          .EQ  $FB  Block 2 (008000-00BFFFh) write-protected
_WRT2_OFF_4L         .EQ  $FF  Block 2 (008000-00BFFFh) not write-protected

_WRT3_ON_4L          .EQ  $F7  Block 3 (00C000-00FFFFh) write-protected
_WRT3_OFF_4L         .EQ  $FF  Block 3 (00C000-00FFFFh) not write-protected

_WRT4_ON_4L          .EQ  $EF  Block 4 (010000-013FFFh) write-protected
_WRT4_OFF_4L         .EQ  $FF  Block 4 (010000-013FFFh) not write-protected

_WRT5_ON_4L          .EQ  $DF  Block 5 (014000-017FFFh) write-protected
_WRT5_OFF_4L         .EQ  $FF  Block 5 (014000-017FFFh) not write-protected

_WRT6_ON_4L          .EQ  $BF  Block 6 (018000-01BFFFh) write-protected
_WRT6_OFF_4L         .EQ  $FF  Block 6 (018000-01BFFFh) not write-protected

_WRT7_ON_4L          .EQ  $7F  Block 7 (01C000-01FFFFh) write-protected
_WRT7_OFF_4L         .EQ  $FF  Block 7 (01C000-01FFFFh) not write-protected
...
_EBTR2_ON_6L         .EQ  $FB  Block 2 (008000-00BFFFh) protected from table reads executed in other blocks
_EBTR2_OFF_6L        .EQ  $FF  Block 2 (008000-00BFFFh) not protected from table reads executed in other blocks

_EBTR3_ON_6L         .EQ  $F7  Block 3 (00C000-00FFFFh) protected from table reads executed in other blocks
_EBTR3_OFF_6L        .EQ  $FF  Block 3 (00C000-00FFFFh) not protected from table reads executed in other blocks

_EBTR4_ON_6L         .EQ  $EF  Block 4 (010000-013FFFh) protected from table reads executed in other blocks
_EBTR4_OFF_6L        .EQ  $FF  Block 4 (010000-013FFFh) not protected from table reads executed in other blocks

_EBTR5_ON_6L         .EQ  $DF  Block 5 (014000-017FFFh) protected from table reads executed in other blocks
_EBTR5_OFF_6L        .EQ  $FF  Block 5 (014000-017FFFh) not protected from table reads executed in other blocks

_EBTR6_ON_6L         .EQ  $BF  Block 6 (018000-01BFFFh) protected from table reads executed in other blocks
_EBTR6_OFF_6L        .EQ  $FF  Block 6 (018000-01BFFFh) not protected from table reads executed in other blocks

_EBTR7_ON_6L         .EQ  $7F  Block 7 (01C000-01FFFFh) protected from table reads executed in other blocks
_EBTR7_OFF_6L        .EQ  $FF  Block 7 (01C000-01FFFFh) not protected from table reads executed in other blocks
