...
;  MPASM PIC18LF6720 processor include
;
...
;  bits of information for the PIC18LF6720 microcontroller.  These names
...
;
;   Code Protection bit:
;     CP6 = ON             Block 6 (018000-01BFFFh) code-protected
;     CP6 = OFF            Block 6 (018000-01BFFFh) not code-protected
;
;   Code Protection bit:
...
_CP6_ON_5L           .EQ  $BF  Block 6 (018000-01BFFFh) code-protected
_CP6_OFF_5L          .EQ  $FF  Block 6 (018000-01BFFFh) not code-protected
...
_WRT6_ON_6L          .EQ  $BF  Block 6 (018000-01BFFFh) write-protected
_WRT6_OFF_6L         .EQ  $FF  Block 6 (018000-01BFFFh) not write-protected
