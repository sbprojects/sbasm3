...
;  MPASM PIC16CR83 processor include
;
...
;  bits of information for the PIC16CR83 microcontroller.  These names
...
_CP_ON               .EQ  $008F  Program memory is code protected
_CP_OFF              .EQ  $3FFF  Code Protection Off

_DP_ON               .EQ  $3F7F  Data memory is code protected
_DP_OFF              .EQ  $3FFF  Code Protection Off
