...
;  MPASM PIC16F18856 processor include
;
...
;  bits of information for the PIC16F18856 microcontroller.  These names
...
_RSTOSC_HFINTPLL     .EQ  $3F9F  HFINTOSC with 2x PLL, with OSCFRQ = 16 MHz and CDIV = 1:! (FOSC = 32 MHz)
