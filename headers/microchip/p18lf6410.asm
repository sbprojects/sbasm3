...
;  MPASM PIC18LF6410 processor include
;
...
;  bits of information for the PIC18LF6410 microcontroller.  These names
...
;----- CONFIG3L Options --------------------------------------------------
;----- CONFIG3H Options --------------------------------------------------
_CCP2MX_PORTE_3H     .EQ  $FE  CCP2 input/output is multiplexed with RE7
