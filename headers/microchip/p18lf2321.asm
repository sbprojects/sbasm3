...
;  MPASM PIC18LF2321 processor include
;
...
;  bits of information for the PIC18LF2321 microcontroller.  These names
...
_OSC_INTIO2_1H       .EQ  $F8  Internal oscillator block, port function on RA6 and RA7
_OSC_INTIO1_1H       .EQ  $F9  Internal oscillator block, CLKO function on RA6, port function on RA7
...
_BOR_NOSLP_2L        .EQ  $FD  Brown-out Reset enabled in hardware only and disabled in Sleep mode (SBOREN is disabled)
...
_PBADEN_DIG_3H       .EQ  $FD  PORTB<4:0> pins are configured as digital I/O on Reset
_PBADEN_ANA_3H       .EQ  $FF  PORTB<4:0> pins are configured as analog input channels on Reset
...
_BBSIZ_BB256_4L      .EQ  $CF   256 Word
_BBSIZ_BB512_4L      .EQ  $DF   512 Word
_BBSIZ_BB1K_4L       .EQ  $FF  1024 Word
