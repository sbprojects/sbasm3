...
def CrossInit():
    ...
    dec.Asm.Instructions = {
     ...
     'CLR'  : (crlib.Singles, ('A', 'C', 'F0', 'F1'), (0x27, 0x97, 0x85, 0xA5),
               ('1', '1', '1', '1')),
     'CPL'  : (crlib.Singles, ('A', 'C', 'F0', 'F1'), (0x37, 0xA7, 0x95, 0xB5),
               ('1', '1', '1', '1')),
     ...
     'EN'   : (crlib.Singles, ('I', 'TCNTI', 'DMA', 'FLAGS'),
               (0x05, 0x25, 0xE5, 0xF5), ('1', '1', '1', '1')),
     'JMPP' : (crlib.Singles, ('@A',), (0xB3,), ('2',)),
     'SEL'  : (crlib.Singles, ('RB0', 'RB1'), (0xC5, 0xD5), ('1', '1')),
     ...
     'IN'   : (crlib.Pairs, ('A,DBB', 'A,P1', 'A,P2'), (0x22, 0x09, 0x0A),
               ('1', '2', '2')),
     'MOVP' : (crlib.Pairs, ('A,@A',), (0xA3,), ('2',)),
     'MOVP3': (crlib.Pairs, ('A,@A',), (0xE3,), ('2',)),
     'ORLD' : (crlib.Pairs, ('P4,A', 'P5,A', 'P6,A', 'P7,A'),
               (0x8C, 0x8D, 0x8E, 0x8F), ('1', '1', '1', '1')),
     'OUT'  : (crlib.Pairs, ('DBB,A',), (0x02,), ('2',)),
     'OUTL' : (crlib.Pairs, ('DBB,A', 'P1,A', 'P2,A'), (0x02, 0x39, 0x3A),
               ('2', '2', '2')),
