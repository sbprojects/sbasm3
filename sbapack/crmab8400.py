...
#   Date  : 2015-12-21
#
#   Cross Overlay for the MAB8400 family of processors
#
# ------------------------------------------------------------------------------
...
def CrossInit():
    ...
    movparams = ('A,R0', 'A,R1', 'A,R2', 'A,R3', 'A,R4', 'A,R5', 'A,R6',
                 ...
                 'A,S0', 'A,S1', 'S0,A', 'S1,A', 'S2,A', 'S0,#', 'S1,#',
                 'S2,#')
    movopcodes = (0xF8, 0xF9, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0xFF, 0xF0, 0xF1,
                  ...
                  0xB1, 0xC7, 0xD7, 0x42, 0x62, 0x0C, 0x0D, 0x3C, 0x3D, 0x3E,
                  0x9C, 0x9D, 0x9E)
    ...
    dec.Asm.Instructions = {
     'JB0'  : (crlib.Branch, 0x12, '2'),
     'JB1'  : (crlib.Branch, 0x32, '2'),
     'JB2'  : (crlib.Branch, 0x52, '2'),
     'JB3'  : (crlib.Branch, 0x72, '2'),
     'JB4'  : (crlib.Branch, 0x92, '2'),
     'JB5'  : (crlib.Branch, 0xB2, '2'),
     'JB6'  : (crlib.Branch, 0xD2, '2'),
     'JB7'  : (crlib.Branch, 0xF2, '2'),
     'JC'   : (crlib.Branch, 0xF6, '2'),
     'JF0'  : (crlib.Branch, 0xB6, '2'),
     'JF1'  : (crlib.Branch, 0x76, '2'),
     'JNC'  : (crlib.Branch, 0xE6, '2'),
     'JNI'  : (crlib.Branch, 0x86, '2'),
     ...
     'JNTF' : (crlib.Branch, 0x06, '2'),

     'CLR'  : (crlib.Singles, ('A', 'C', 'F0', 'F1'),
               (0x27, 0x97, 0x85, 0xA5), ('1', '1', '1', '1')),
     'CPL'  : (crlib.Singles, ('A', 'C', 'F0', 'F1'),
               (0x37, 0xA7, 0x95, 0xB5), ('1', '1', '1', '1')),
     'DA'   : (crlib.Singles, ('A',), (0x57,), ('1',)),
     'DEC'  : (crlib.Singles, ('A', 'R0', 'R1', 'R2', 'R3', 'R4', 'R5', 'R6',
                               'R7', '@R0', '@R1'),
               (0x07, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF, 0xC0,
                0xC1),
     ...
     'DIS'  : (crlib.Singles, ('I', 'TCNTI', 'SI'), (0x15, 0x35, 0x95),
               ('1', '1', '1')),
     'EN'   : (crlib.Singles, ('I', 'TCNTI', 'SI'), (0x05, 0x25, 0x85),
               ('1', '1', '1')),
     'ENT0' : (crlib.Singles, ('CLK',), (0x75,), ('1',)),
     'JMPP' : (crlib.Singles, ('@A',), (0xB3,), ('2',)),
     'SEL'  : (crlib.Singles, ('MB0', 'MB1', 'MB2', 'MB3', 'RB0', 'RB1'),
               (0xE5, 0xF5, 0xA5, 0xB5, 0xC5, 0xD5),
               ('1', '1', '1', '1', '1', '1')),
     ...
     'IN'   : (crlib.Pairs, ('A,P0', 'A,P1', 'A,P2'), (0x08, 0x09, 0x0A),
               ('2', '2', '2')),
     'MOVP' : (crlib.Pairs, ('A,@A',), (0xA3,), ('2',)),
     'OUTL' : (crlib.Pairs, ('P0,A', 'P1,A', 'P2,A'), (0x38, 0x39, 0x3A),
               ('2', '2', '2')),

     'NOP'  : (crlib.Implied, 0x00, '1'),
     'RET'  : (crlib.Implied, 0x83, '2'),
     'RETR' : (crlib.Implied, 0x93, '2'),

     'CALL' : (crlib.Absolute, 0x14, '2'),
     'JMP'  : (crlib.Absolute, 0x04, '2'),

     'DJNZ' : (crlib.Djnz, (0xE8, 0xE0), '2')
    }
